{
  ...
  inputs.src-xmlio-v0_1_10.flake = false;
  inputs.src-xmlio-v0_1_10.owner = "codehz";
  inputs.src-xmlio-v0_1_10.ref   = "refs/tags/v0.1.10";
  inputs.src-xmlio-v0_1_10.repo  = "xmlio";
  inputs.src-xmlio-v0_1_10.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-xmlio-v0_1_10"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-xmlio-v0_1_10";
