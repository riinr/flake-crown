{
  ...
  inputs."unchained-v0_2_0".dir   = "v0_2_0";
  inputs."unchained-v0_2_0".owner = "nim-nix-pkgs";
  inputs."unchained-v0_2_0".ref   = "master";
  inputs."unchained-v0_2_0".repo  = "unchained";
  inputs."unchained-v0_2_0".type  = "github";
  inputs."unchained-v0_2_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."unchained-v0_2_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."unchained-v0_2_1".dir   = "v0_2_1";
  inputs."unchained-v0_2_1".owner = "nim-nix-pkgs";
  inputs."unchained-v0_2_1".ref   = "master";
  inputs."unchained-v0_2_1".repo  = "unchained";
  inputs."unchained-v0_2_1".type  = "github";
  inputs."unchained-v0_2_1".inputs.nixpkgs.follows = "nixpkgs";
  inputs."unchained-v0_2_1".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."unchained-v0_2_2".dir   = "v0_2_2";
  inputs."unchained-v0_2_2".owner = "nim-nix-pkgs";
  inputs."unchained-v0_2_2".ref   = "master";
  inputs."unchained-v0_2_2".repo  = "unchained";
  inputs."unchained-v0_2_2".type  = "github";
  inputs."unchained-v0_2_2".inputs.nixpkgs.follows = "nixpkgs";
  inputs."unchained-v0_2_2".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."unchained-v0_2_3".dir   = "v0_2_3";
  inputs."unchained-v0_2_3".owner = "nim-nix-pkgs";
  inputs."unchained-v0_2_3".ref   = "master";
  inputs."unchained-v0_2_3".repo  = "unchained";
  inputs."unchained-v0_2_3".type  = "github";
  inputs."unchained-v0_2_3".inputs.nixpkgs.follows = "nixpkgs";
  inputs."unchained-v0_2_3".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."unchained-v0_2_4".dir   = "v0_2_4";
  inputs."unchained-v0_2_4".owner = "nim-nix-pkgs";
  inputs."unchained-v0_2_4".ref   = "master";
  inputs."unchained-v0_2_4".repo  = "unchained";
  inputs."unchained-v0_2_4".type  = "github";
