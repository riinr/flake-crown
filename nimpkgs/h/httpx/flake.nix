{
  ...
  inputs."httpx-v0_3_0".dir   = "v0_3_0";
  inputs."httpx-v0_3_0".owner = "nim-nix-pkgs";
  inputs."httpx-v0_3_0".ref   = "master";
  inputs."httpx-v0_3_0".repo  = "httpx";
  inputs."httpx-v0_3_0".type  = "github";
  inputs."httpx-v0_3_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."httpx-v0_3_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."httpx-v0_3_2".dir   = "v0_3_2";
  inputs."httpx-v0_3_2".owner = "nim-nix-pkgs";
  inputs."httpx-v0_3_2".ref   = "master";
  inputs."httpx-v0_3_2".repo  = "httpx";
  inputs."httpx-v0_3_2".type  = "github";
  inputs."httpx-v0_3_2".inputs.nixpkgs.follows = "nixpkgs";
  inputs."httpx-v0_3_2".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."httpx-v0_3_4".dir   = "v0_3_4";
  inputs."httpx-v0_3_4".owner = "nim-nix-pkgs";
  inputs."httpx-v0_3_4".ref   = "master";
  inputs."httpx-v0_3_4".repo  = "httpx";
  inputs."httpx-v0_3_4".type  = "github";
  inputs."httpx-v0_3_4".inputs.nixpkgs.follows = "nixpkgs";
  inputs."httpx-v0_3_4".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
