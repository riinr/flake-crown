{
  ...
  inputs.src-hmisc-devel.flake = false;
  inputs.src-hmisc-devel.ref   = "refs/heads/devel";
  inputs.src-hmisc-devel.owner = "haxscramper";
  inputs.src-hmisc-devel.repo  = "hmisc";
  inputs.src-hmisc-devel.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-hmisc-devel"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-hmisc-devel";
