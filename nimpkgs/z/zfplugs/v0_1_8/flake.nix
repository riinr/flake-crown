{
  ...
  inputs.src-zfplugs-v0_1_8.flake = false;
  inputs.src-zfplugs-v0_1_8.ref   = "refs/tags/v0.1.8";
  inputs.src-zfplugs-v0_1_8.owner = "zendbit";
  inputs.src-zfplugs-v0_1_8.repo  = "nim.zfplugs";
  inputs.src-zfplugs-v0_1_8.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfplugs-v0_1_8"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfplugs-v0_1_8";
