{
  ...
  inputs.src-zfplugs-v1_1_16.flake = false;
  inputs.src-zfplugs-v1_1_16.ref   = "refs/tags/v1.1.16";
  inputs.src-zfplugs-v1_1_16.owner = "zendbit";
  inputs.src-zfplugs-v1_1_16.repo  = "nim.zfplugs";
  inputs.src-zfplugs-v1_1_16.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfplugs-v1_1_16"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfplugs-v1_1_16";
