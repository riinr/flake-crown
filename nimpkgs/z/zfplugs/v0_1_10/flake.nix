{
  ...
  inputs.src-zfplugs-v0_1_10.flake = false;
  inputs.src-zfplugs-v0_1_10.ref   = "refs/tags/v0.1.10";
  inputs.src-zfplugs-v0_1_10.owner = "zendbit";
  inputs.src-zfplugs-v0_1_10.repo  = "nim.zfplugs";
  inputs.src-zfplugs-v0_1_10.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfplugs-v0_1_10"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfplugs-v0_1_10";
