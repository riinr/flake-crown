{
  ...
  inputs.src-zfblast-v0_2_5.flake = false;
  inputs.src-zfblast-v0_2_5.ref   = "refs/tags/v0.2.5";
  inputs.src-zfblast-v0_2_5.owner = "zendbit";
  inputs.src-zfblast-v0_2_5.repo  = "nim.zfblast";
  inputs.src-zfblast-v0_2_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfblast-v0_2_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfblast-v0_2_5";
