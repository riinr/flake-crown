{
  ...
  inputs.src-zfblast-v0_1_17.flake = false;
  inputs.src-zfblast-v0_1_17.ref   = "refs/tags/v0.1.17";
  inputs.src-zfblast-v0_1_17.owner = "zendbit";
  inputs.src-zfblast-v0_1_17.repo  = "nim.zfblast";
  inputs.src-zfblast-v0_1_17.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfblast-v0_1_17"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-zfblast-v0_1_17";
