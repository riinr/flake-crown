{
  ...
  inputs.src-zfcore-vbeta-1_1_18.flake = false;
  inputs.src-zfcore-vbeta-1_1_18.ref   = "refs/tags/vbeta-1.1.18";
  inputs.src-zfcore-vbeta-1_1_18.owner = "zendbit";
  inputs.src-zfcore-vbeta-1_1_18.repo  = "nim.zfcore";
  inputs.src-zfcore-vbeta-1_1_18.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfcore-vbeta-1_1_18"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfcore-vbeta-1_1_18";
