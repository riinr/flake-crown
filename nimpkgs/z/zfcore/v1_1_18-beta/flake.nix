{
  ...
  inputs.src-zfcore-v1_1_18-beta.flake = false;
  inputs.src-zfcore-v1_1_18-beta.ref   = "refs/tags/v1.1.18-beta";
  inputs.src-zfcore-v1_1_18-beta.owner = "zendbit";
  inputs.src-zfcore-v1_1_18-beta.repo  = "nim.zfcore";
  inputs.src-zfcore-v1_1_18-beta.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfcore-v1_1_18-beta"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfcore-v1_1_18-beta";
