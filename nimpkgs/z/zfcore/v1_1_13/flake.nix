{
  ...
  inputs.src-zfcore-v1_1_13.flake = false;
  inputs.src-zfcore-v1_1_13.ref   = "refs/tags/v1.1.13";
  inputs.src-zfcore-v1_1_13.owner = "zendbit";
  inputs.src-zfcore-v1_1_13.repo  = "nim.zfcore";
  inputs.src-zfcore-v1_1_13.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfcore-v1_1_13"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfcore-v1_1_13";
