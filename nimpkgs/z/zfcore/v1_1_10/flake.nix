{
  ...
  inputs.src-zfcore-v1_1_10.flake = false;
  inputs.src-zfcore-v1_1_10.ref   = "refs/tags/v1.1.10";
  inputs.src-zfcore-v1_1_10.owner = "zendbit";
  inputs.src-zfcore-v1_1_10.repo  = "nim.zfcore";
  inputs.src-zfcore-v1_1_10.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfcore-v1_1_10"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfcore-v1_1_10";
