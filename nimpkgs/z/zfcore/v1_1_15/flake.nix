{
  ...
  inputs.src-zfcore-v1_1_15.flake = false;
  inputs.src-zfcore-v1_1_15.ref   = "refs/tags/v1.1.15";
  inputs.src-zfcore-v1_1_15.owner = "zendbit";
  inputs.src-zfcore-v1_1_15.repo  = "nim.zfcore";
  inputs.src-zfcore-v1_1_15.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfcore-v1_1_15"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfcore-v1_1_15";
