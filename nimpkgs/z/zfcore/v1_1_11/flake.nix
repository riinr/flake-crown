{
  ...
  inputs.src-zfcore-v1_1_11.flake = false;
  inputs.src-zfcore-v1_1_11.ref   = "refs/tags/v1.1.11";
  inputs.src-zfcore-v1_1_11.owner = "zendbit";
  inputs.src-zfcore-v1_1_11.repo  = "nim.zfcore";
  inputs.src-zfcore-v1_1_11.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfcore-v1_1_11"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfcore-v1_1_11";
