{
  ...
  inputs.src-zfcore-v1_1_17.flake = false;
  inputs.src-zfcore-v1_1_17.ref   = "refs/tags/v1.1.17";
  inputs.src-zfcore-v1_1_17.owner = "zendbit";
  inputs.src-zfcore-v1_1_17.repo  = "nim.zfcore";
  inputs.src-zfcore-v1_1_17.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfcore-v1_1_17"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfcore-v1_1_17";
