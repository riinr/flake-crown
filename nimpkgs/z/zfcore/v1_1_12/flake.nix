{
  ...
  inputs.src-zfcore-v1_1_12.flake = false;
  inputs.src-zfcore-v1_1_12.ref   = "refs/tags/v1.1.12";
  inputs.src-zfcore-v1_1_12.owner = "zendbit";
  inputs.src-zfcore-v1_1_12.repo  = "nim.zfcore";
  inputs.src-zfcore-v1_1_12.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-zfcore-v1_1_12"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-zfcore-v1_1_12";
