{
  ...
  inputs.src-paranim-0_10_0.flake = false;
  inputs.src-paranim-0_10_0.ref   = "refs/tags/0.10.0";
  inputs.src-paranim-0_10_0.owner = "paranim";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-paranim-0_10_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-paranim-0_10_0";
