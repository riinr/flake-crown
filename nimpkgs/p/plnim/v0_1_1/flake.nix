{
  ...
  inputs.src-plnim-v0_1_1.flake = false;
  inputs.src-plnim-v0_1_1.owner = "luisacosta828";
  inputs.src-plnim-v0_1_1.ref   = "refs/tags/v0.1.1";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-plnim-v0_1_1"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-plnim-v0_1_1";
