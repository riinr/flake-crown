{
  ...
  inputs.src-prologue-v0_5_4.flake = false;
  inputs.src-prologue-v0_5_4.owner = "planety";
  inputs.src-prologue-v0_5_4.ref   = "refs/tags/v0.5.4";
  inputs.src-prologue-v0_5_4.repo  = "Prologue";
  inputs.src-prologue-v0_5_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-prologue-v0_5_4"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-prologue-v0_5_4";
