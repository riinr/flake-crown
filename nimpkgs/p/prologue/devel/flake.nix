{
  ...
  inputs.src-prologue-devel.flake = false;
  inputs.src-prologue-devel.ref   = "refs/heads/devel";
  inputs.src-prologue-devel.owner = "planety";
  inputs.src-prologue-devel.repo  = "Prologue";
  inputs.src-prologue-devel.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-prologue-devel"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-prologue-devel";
