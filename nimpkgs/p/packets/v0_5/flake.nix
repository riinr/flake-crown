{
  ...
  inputs.src-packets-v0_5.flake = false;
  inputs.src-packets-v0_5.ref   = "refs/tags/v0.5";
  inputs.src-packets-v0_5.owner = "Q-Master";
  inputs.src-packets-v0_5.repo  = "packets.nim";
  inputs.src-packets-v0_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-packets-v0_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-packets-v0_5";
