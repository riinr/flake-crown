{
  ...
  inputs.src-pwnedpass-v2_0_2.flake = false;
  inputs.src-pwnedpass-v2_0_2.ref   = "refs/tags/v2.0.2";
  inputs.src-pwnedpass-v2_0_2.owner = "foxoman";
  inputs.src-pwnedpass-v2_0_2.repo  = "pwnedpass";
  inputs.src-pwnedpass-v2_0_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-pwnedpass-v2_0_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-pwnedpass-v2_0_2";
