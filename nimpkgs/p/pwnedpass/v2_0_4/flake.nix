{
  ...
  inputs.src-pwnedpass-v2_0_4.flake = false;
  inputs.src-pwnedpass-v2_0_4.ref   = "refs/tags/v2.0.4";
  inputs.src-pwnedpass-v2_0_4.owner = "foxoman";
  inputs.src-pwnedpass-v2_0_4.repo  = "pwnedpass";
  inputs.src-pwnedpass-v2_0_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-pwnedpass-v2_0_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-pwnedpass-v2_0_4";
