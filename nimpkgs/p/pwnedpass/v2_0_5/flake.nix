{
  ...
  inputs.src-pwnedpass-v2_0_5.flake = false;
  inputs.src-pwnedpass-v2_0_5.ref   = "refs/tags/v2.0.5";
  inputs.src-pwnedpass-v2_0_5.owner = "foxoman";
  inputs.src-pwnedpass-v2_0_5.repo  = "pwnedpass";
  inputs.src-pwnedpass-v2_0_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-pwnedpass-v2_0_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-pwnedpass-v2_0_5";
