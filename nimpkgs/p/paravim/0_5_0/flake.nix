{
  ...
  inputs.src-paravim-0_5_0.flake = false;
  inputs.src-paravim-0_5_0.ref   = "refs/tags/0.5.0";
  inputs.src-paravim-0_5_0.owner = "paranim";
  inputs.src-paravim-0_5_0.repo  = "paravim";
  inputs.src-paravim-0_5_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-paravim-0_5_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-paravim-0_5_0";
