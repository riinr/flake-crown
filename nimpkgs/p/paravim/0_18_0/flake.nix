{
  ...
  inputs.src-paravim-0_18_0.flake = false;
  inputs.src-paravim-0_18_0.owner = "paranim";
  inputs.src-paravim-0_18_0.ref   = "refs/tags/0.18.0";
  inputs.src-paravim-0_18_0.repo  = "paravim";
  inputs.src-paravim-0_18_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-paravim-0_18_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-paravim-0_18_0";
