{
  ...
  inputs.src-pvim-0_14_0.flake = false;
  inputs.src-pvim-0_14_0.ref   = "refs/tags/0.14.0";
  inputs.src-pvim-0_14_0.owner = "paranim";
  inputs.src-pvim-0_14_0.repo  = "pvim";
  inputs.src-pvim-0_14_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-pvim-0_14_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-pvim-0_14_0";
