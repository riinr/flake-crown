{
  ...
  inputs.src-peni-v0_4_5.flake = false;
  inputs.src-peni-v0_4_5.ref   = "refs/tags/v0.4.5";
  inputs.src-peni-v0_4_5.owner = "srozb";
  inputs.src-peni-v0_4_5.repo  = "peni";
  inputs.src-peni-v0_4_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-peni-v0_4_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-peni-v0_4_5";
