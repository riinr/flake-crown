{
  ...
  inputs.src-peni-v0_3_3-test.flake = false;
  inputs.src-peni-v0_3_3-test.ref   = "refs/tags/v0.3.3-test";
  inputs.src-peni-v0_3_3-test.owner = "srozb";
  inputs.src-peni-v0_3_3-test.repo  = "peni";
  inputs.src-peni-v0_3_3-test.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-peni-v0_3_3-test"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-peni-v0_3_3-test";
