{
  ...
  inputs.src-pixie-3_0_0.flake = false;
  inputs.src-pixie-3_0_0.ref   = "refs/tags/3.0.0";
  inputs.src-pixie-3_0_0.owner = "treeform";
  inputs.src-pixie-3_0_0.repo  = "pixie";
  inputs.src-pixie-3_0_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-pixie-3_0_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-pixie-3_0_0";
