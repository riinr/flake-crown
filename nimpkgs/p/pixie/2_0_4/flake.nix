{
  ...
  inputs.src-pixie-2_0_4.flake = false;
  inputs.src-pixie-2_0_4.ref   = "refs/tags/2.0.4";
  inputs.src-pixie-2_0_4.owner = "treeform";
  inputs.src-pixie-2_0_4.repo  = "pixie";
  inputs.src-pixie-2_0_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-pixie-2_0_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-pixie-2_0_4";
