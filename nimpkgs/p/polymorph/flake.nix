{
  ...
  inputs."polymorph-v0_3_1".dir   = "v0_3_1";
  inputs."polymorph-v0_3_1".owner = "nim-nix-pkgs";
  inputs."polymorph-v0_3_1".ref   = "master";
  inputs."polymorph-v0_3_1".repo  = "polymorph";
  inputs."polymorph-v0_3_1".type  = "github";
  inputs."polymorph-v0_3_1".inputs.nixpkgs.follows = "nixpkgs";
  inputs."polymorph-v0_3_1".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
