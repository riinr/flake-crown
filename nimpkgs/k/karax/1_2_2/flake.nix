{
  ...
  inputs.src-karax-1_2_2.flake = false;
  inputs.src-karax-1_2_2.ref   = "refs/tags/1.2.2";
  inputs.src-karax-1_2_2.owner = "karaxnim";
  inputs.src-karax-1_2_2.repo  = "karax";
  inputs.src-karax-1_2_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-karax-1_2_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-karax-1_2_2";
