{
  ...
  inputs.src-kombinator-1_0_1.ref   = "1_0_1";
  inputs.src-kombinator-1_0_1.repo  = "kombinator.git";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-kombinator-1_0_1"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-kombinator-1_0_1";
