{
  ...
  inputs.src-kombinator-1_2_0.ref   = "1_2_0";
  inputs.src-kombinator-1_2_0.repo  = "kombinator.git";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-kombinator-1_2_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-kombinator-1_2_0";
