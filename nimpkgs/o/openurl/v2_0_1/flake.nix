{
  ...
  inputs.src-openurl-v2_0_1.flake = false;
  inputs.src-openurl-v2_0_1.ref   = "refs/tags/v2.0.1";
  inputs.src-openurl-v2_0_1.owner = "foxoman";
  inputs.src-openurl-v2_0_1.repo  = "openurl";
  inputs.src-openurl-v2_0_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-openurl-v2_0_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-openurl-v2_0_1";
