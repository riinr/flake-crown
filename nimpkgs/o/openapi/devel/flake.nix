{
  ...
  inputs.src-openapi-devel.flake = false;
  inputs.src-openapi-devel.ref   = "refs/heads/devel";
  inputs.src-openapi-devel.owner = "disruptek";
  inputs.src-openapi-devel.repo  = "openapi";
  inputs.src-openapi-devel.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-openapi-devel"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-openapi-devel";
