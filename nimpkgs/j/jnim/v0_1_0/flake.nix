{
  ...
  inputs.src-jnim-v0_1_0.flake = false;
  inputs.src-jnim-v0_1_0.owner = "yglukhov";
  inputs.src-jnim-v0_1_0.ref   = "refs/tags/v0.1.0";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-jnim-v0_1_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-jnim-v0_1_0";
