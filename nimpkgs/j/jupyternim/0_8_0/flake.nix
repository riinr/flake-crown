{
  ...
  inputs.src-jupyternim-0_8_0.flake = false;
  inputs.src-jupyternim-0_8_0.ref   = "refs/tags/0.8.0";
  inputs.src-jupyternim-0_8_0.owner = "stisa";
  inputs.src-jupyternim-0_8_0.repo  = "jupyternim";
  inputs.src-jupyternim-0_8_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-jupyternim-0_8_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-jupyternim-0_8_0";
