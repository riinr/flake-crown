{
  ...
  inputs.src-jupyternim-0_2_0.flake = false;
  inputs.src-jupyternim-0_2_0.owner = "stisa";
  inputs.src-jupyternim-0_2_0.ref   = "0_2_0";
  inputs.src-jupyternim-0_2_0.repo  = "jupyternim";
  inputs.src-jupyternim-0_2_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-jupyternim-0_2_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-jupyternim-0_2_0";
