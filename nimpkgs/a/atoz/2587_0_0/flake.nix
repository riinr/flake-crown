{
  ...
  inputs.src-atoz-2587_0_0.flake = false;
  inputs.src-atoz-2587_0_0.ref   = "refs/tags/2587.0.0";
  inputs.src-atoz-2587_0_0.owner = "disruptek";
  inputs.src-atoz-2587_0_0.repo  = "atoz";
  inputs.src-atoz-2587_0_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-atoz-2587_0_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-atoz-2587_0_0";
