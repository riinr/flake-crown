{
  ...
  inputs.src-atoz-2533_0_0.flake = false;
  inputs.src-atoz-2533_0_0.ref   = "refs/tags/2533.0.0";
  inputs.src-atoz-2533_0_0.owner = "disruptek";
  inputs.src-atoz-2533_0_0.repo  = "atoz";
  inputs.src-atoz-2533_0_0.type  = "github";
  
  inputs."openapi".owner = "nim-nix-pkgs";
  inputs."openapi".ref   = "master";
  inputs."openapi".repo  = "openapi";
  inputs."openapi".dir   = "2_0_0";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-atoz-2533_0_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-atoz-2533_0_0";
