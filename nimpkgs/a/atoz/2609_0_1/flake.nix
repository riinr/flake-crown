{
  ...
  inputs.src-atoz-2609_0_1.flake = false;
  inputs.src-atoz-2609_0_1.owner = "disruptek";
  inputs.src-atoz-2609_0_1.ref   = "refs/tags/2609.0.1";
  inputs.src-atoz-2609_0_1.repo  = "atoz";
  inputs.src-atoz-2609_0_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-atoz-2609_0_1"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-atoz-2609_0_1";
