{
  ...
  inputs.src-atoz-2606_0_0.flake = false;
  inputs.src-atoz-2606_0_0.ref   = "refs/tags/2606.0.0";
  inputs.src-atoz-2606_0_0.owner = "disruptek";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-atoz-2606_0_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-atoz-2606_0_0";
