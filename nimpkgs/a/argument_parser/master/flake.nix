{
  ...
  inputs."https://github.com/xe/badger_bits.git".owner = "nim-nix-pkgs";
  inputs."https://github.com/xe/badger_bits.git".ref   = "master";
  inputs."https://github.com/xe/badger_bits.git".repo  = "https://github.com/xe/badger_bits.git";
