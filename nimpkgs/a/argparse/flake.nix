{
  ...
  inputs."argparse-v4_0_1".dir   = "v4_0_1";
  inputs."argparse-v4_0_1".owner = "nim-nix-pkgs";
  inputs."argparse-v4_0_1".ref   = "master";
  inputs."argparse-v4_0_1".repo  = "argparse";
  inputs."argparse-v4_0_1".type  = "github";
  inputs."argparse-v4_0_1".inputs.nixpkgs.follows = "nixpkgs";
  inputs."argparse-v4_0_1".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
