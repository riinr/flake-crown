{
  ...
  inputs.src-anonimongo-v0_4_7.flake = false;
  inputs.src-anonimongo-v0_4_7.owner = "mashingan";
  inputs.src-anonimongo-v0_4_7.ref   = "refs/tags/v0.4.7";
  inputs.src-anonimongo-v0_4_7.repo  = "anonimongo";
  inputs.src-anonimongo-v0_4_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-anonimongo-v0_4_7"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-anonimongo-v0_4_7";
