{
  ...
  inputs.src-anonimongo-v0_5_4.flake = false;
  inputs.src-anonimongo-v0_5_4.ref   = "refs/tags/v0.5.4";
  inputs.src-anonimongo-v0_5_4.owner = "mashingan";
  inputs.src-anonimongo-v0_5_4.repo  = "anonimongo";
  inputs.src-anonimongo-v0_5_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-anonimongo-v0_5_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-anonimongo-v0_5_4";
