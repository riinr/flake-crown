{
  ...
  inputs.src-anonimongo-v0_4_2.flake = false;
  inputs.src-anonimongo-v0_4_2.ref   = "refs/tags/v0.4.2";
  inputs.src-anonimongo-v0_4_2.owner = "mashingan";
  inputs.src-anonimongo-v0_4_2.repo  = "anonimongo";
  inputs.src-anonimongo-v0_4_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-anonimongo-v0_4_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-anonimongo-v0_4_2";
