{
  ...
  inputs.src-allographer-v0_18_1.flake = false;
  inputs.src-allographer-v0_18_1.owner = "itsumura-h";
  inputs.src-allographer-v0_18_1.ref   = "refs/tags/v0.18.1";
  inputs.src-allographer-v0_18_1.repo  = "nim-allographer";
  inputs.src-allographer-v0_18_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-allographer-v0_18_1"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-allographer-v0_18_1";
