{
  ...
  inputs.src-arraymancer-v0_7_0.flake = false;
  inputs.src-arraymancer-v0_7_0.ref   = "refs/tags/v0.7.0";
  inputs.src-arraymancer-v0_7_0.owner = "mratsim";
  inputs.src-arraymancer-v0_7_0.repo  = "Arraymancer";
  inputs.src-arraymancer-v0_7_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-arraymancer-v0_7_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-arraymancer-v0_7_0";
