{
  ...
  inputs.src-arraymancer-v0_6_0.flake = false;
  inputs.src-arraymancer-v0_6_0.ref   = "refs/tags/v0.6.0";
  inputs.src-arraymancer-v0_6_0.owner = "mratsim";
  inputs.src-arraymancer-v0_6_0.repo  = "Arraymancer";
  inputs.src-arraymancer-v0_6_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-arraymancer-v0_6_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-arraymancer-v0_6_0";
