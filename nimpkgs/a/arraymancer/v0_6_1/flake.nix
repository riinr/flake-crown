{
  ...
  inputs.src-arraymancer-v0_6_1.flake = false;
  inputs.src-arraymancer-v0_6_1.owner = "mratsim";
  inputs.src-arraymancer-v0_6_1.ref   = "refs/tags/v0.6.1";
  inputs.src-arraymancer-v0_6_1.repo  = "Arraymancer";
  inputs.src-arraymancer-v0_6_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-arraymancer-v0_6_1"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-arraymancer-v0_6_1";
