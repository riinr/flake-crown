{
  ...
  inputs.src-arraymancer-v0_7_14.flake = false;
  inputs.src-arraymancer-v0_7_14.ref   = "refs/tags/v0.7.14";
  inputs.src-arraymancer-v0_7_14.owner = "mratsim";
  inputs.src-arraymancer-v0_7_14.repo  = "Arraymancer";
  inputs.src-arraymancer-v0_7_14.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-arraymancer-v0_7_14"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-arraymancer-v0_7_14";
