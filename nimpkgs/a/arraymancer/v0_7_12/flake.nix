{
  ...
  inputs.src-arraymancer-v0_7_12.flake = false;
  inputs.src-arraymancer-v0_7_12.ref   = "refs/tags/v0.7.12";
  inputs.src-arraymancer-v0_7_12.owner = "mratsim";
  inputs.src-arraymancer-v0_7_12.repo  = "Arraymancer";
  inputs.src-arraymancer-v0_7_12.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-arraymancer-v0_7_12"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-arraymancer-v0_7_12";
