{
  ...
  inputs.src-arraymancer-v0_7_16.flake = false;
  inputs.src-arraymancer-v0_7_16.ref   = "refs/tags/v0.7.16";
  inputs.src-arraymancer-v0_7_16.owner = "mratsim";
  inputs.src-arraymancer-v0_7_16.repo  = "Arraymancer";
  inputs.src-arraymancer-v0_7_16.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-arraymancer-v0_7_16"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-arraymancer-v0_7_16";
