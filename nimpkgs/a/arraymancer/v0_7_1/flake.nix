{
  ...
  inputs.src-arraymancer-v0_7_1.flake = false;
  inputs.src-arraymancer-v0_7_1.ref   = "refs/tags/v0.7.1";
  inputs.src-arraymancer-v0_7_1.owner = "mratsim";
  inputs.src-arraymancer-v0_7_1.repo  = "Arraymancer";
  inputs.src-arraymancer-v0_7_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-arraymancer-v0_7_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-arraymancer-v0_7_1";
