{
  ...
  inputs.src-arraymancer-v0_7_13.flake = false;
  inputs.src-arraymancer-v0_7_13.ref   = "refs/tags/v0.7.13";
  inputs.src-arraymancer-v0_7_13.owner = "mratsim";
  inputs.src-arraymancer-v0_7_13.repo  = "Arraymancer";
  inputs.src-arraymancer-v0_7_13.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-arraymancer-v0_7_13"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-arraymancer-v0_7_13";
