{
  ...
  inputs.src-arraymancer-v0_7_15.flake = false;
  inputs.src-arraymancer-v0_7_15.ref   = "refs/tags/v0.7.15";
  inputs.src-arraymancer-v0_7_15.owner = "mratsim";
  inputs.src-arraymancer-v0_7_15.repo  = "Arraymancer";
  inputs.src-arraymancer-v0_7_15.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-arraymancer-v0_7_15"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-arraymancer-v0_7_15";
