{
  ...
  inputs.src-ansiwave-0_6_0-macos.ref   = "refs/tags/0.6.0-macos";
  inputs.src-ansiwave-0_6_0-macos.owner = "ansiwave";
  inputs.src-ansiwave-0_6_0-macos.repo  = "ansiwave";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-0_6_0-macos"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-0_6_0-macos";
