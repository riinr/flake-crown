{
  ...
  inputs.src-ansiwave-1_7_7.flake = false;
  inputs.src-ansiwave-1_7_7.ref   = "refs/tags/1.7.7";
  inputs.src-ansiwave-1_7_7.owner = "ansiwave";
  inputs.src-ansiwave-1_7_7.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_7"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_7";
