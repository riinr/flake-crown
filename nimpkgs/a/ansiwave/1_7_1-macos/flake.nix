{
  ...
  inputs.src-ansiwave-1_7_1-macos.flake = false;
  inputs.src-ansiwave-1_7_1-macos.ref   = "refs/tags/1.7.1-macos";
  inputs.src-ansiwave-1_7_1-macos.owner = "ansiwave";
  inputs.src-ansiwave-1_7_1-macos.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_1-macos.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_1-macos"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_1-macos";
