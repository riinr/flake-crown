{
  ...
  inputs.src-ansiwave-1_7_11.flake = false;
  inputs.src-ansiwave-1_7_11.ref   = "refs/tags/1.7.11";
  inputs.src-ansiwave-1_7_11.owner = "ansiwave";
  inputs.src-ansiwave-1_7_11.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_11.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_11"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_11";
