{
  ...
  inputs.src-ansiwave-1_7_3.flake = false;
  inputs.src-ansiwave-1_7_3.ref   = "refs/tags/1.7.3";
  inputs.src-ansiwave-1_7_3.owner = "ansiwave";
  inputs.src-ansiwave-1_7_3.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_3";
