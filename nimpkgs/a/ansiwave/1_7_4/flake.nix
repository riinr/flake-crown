{
  ...
  inputs.src-ansiwave-1_7_4.flake = false;
  inputs.src-ansiwave-1_7_4.ref   = "refs/tags/1.7.4";
  inputs.src-ansiwave-1_7_4.owner = "ansiwave";
  inputs.src-ansiwave-1_7_4.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_4";
