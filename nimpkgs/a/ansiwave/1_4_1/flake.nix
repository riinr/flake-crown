{
  ...
  inputs.src-ansiwave-1_4_1.flake = false;
  inputs.src-ansiwave-1_4_1.ref   = "refs/tags/1.4.1";
  inputs.src-ansiwave-1_4_1.owner = "ansiwave";
  inputs.src-ansiwave-1_4_1.repo  = "ansiwave";
  inputs.src-ansiwave-1_4_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_4_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_4_1";
