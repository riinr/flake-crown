{
  ...
  inputs.src-ansiwave-1_7_8.flake = false;
  inputs.src-ansiwave-1_7_8.ref   = "refs/tags/1.7.8";
  inputs.src-ansiwave-1_7_8.owner = "ansiwave";
  inputs.src-ansiwave-1_7_8.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_8.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_8"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_8";
