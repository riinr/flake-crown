{
  ...
  inputs.src-ansiwave-0_3_0-macos.flake = false;
  inputs.src-ansiwave-0_3_0-macos.ref   = "refs/tags/0.3.0-macos";
  inputs.src-ansiwave-0_3_0-macos.owner = "ansiwave";
  inputs.src-ansiwave-0_3_0-macos.repo  = "ansiwave";
  inputs.src-ansiwave-0_3_0-macos.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-0_3_0-macos"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-0_3_0-macos";
