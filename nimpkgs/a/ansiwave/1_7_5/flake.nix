{
  ...
  inputs.src-ansiwave-1_7_5.flake = false;
  inputs.src-ansiwave-1_7_5.ref   = "refs/tags/1.7.5";
  inputs.src-ansiwave-1_7_5.owner = "ansiwave";
  inputs.src-ansiwave-1_7_5.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_5";
