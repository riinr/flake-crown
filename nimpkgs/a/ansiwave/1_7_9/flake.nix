{
  ...
  inputs.src-ansiwave-1_7_9.flake = false;
  inputs.src-ansiwave-1_7_9.ref   = "refs/tags/1.7.9";
  inputs.src-ansiwave-1_7_9.owner = "ansiwave";
  inputs.src-ansiwave-1_7_9.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_9.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_9"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_9";
