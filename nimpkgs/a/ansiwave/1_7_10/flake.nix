{
  ...
  inputs.src-ansiwave-1_7_10.flake = false;
  inputs.src-ansiwave-1_7_10.ref   = "refs/tags/1.7.10";
  inputs.src-ansiwave-1_7_10.owner = "ansiwave";
  inputs.src-ansiwave-1_7_10.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_10.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_10"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_10";
