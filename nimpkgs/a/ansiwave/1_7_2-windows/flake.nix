{
  ...
  inputs.src-ansiwave-1_7_2-windows.flake = false;
  inputs.src-ansiwave-1_7_2-windows.ref   = "refs/tags/1.7.2-windows";
  inputs.src-ansiwave-1_7_2-windows.owner = "ansiwave";
  inputs.src-ansiwave-1_7_2-windows.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_2-windows.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_2-windows"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_2-windows";
