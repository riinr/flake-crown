{
  ...
  inputs.src-ansiwave-1_7_11-linux.flake = false;
  inputs.src-ansiwave-1_7_11-linux.ref   = "refs/tags/1.7.11-linux";
  inputs.src-ansiwave-1_7_11-linux.owner = "ansiwave";
  inputs.src-ansiwave-1_7_11-linux.repo  = "ansiwave";
  inputs.src-ansiwave-1_7_11-linux.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_7_11-linux"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_7_11-linux";
