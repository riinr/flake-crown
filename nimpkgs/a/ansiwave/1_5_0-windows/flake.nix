{
  ...
  inputs.src-ansiwave-1_5_0-windows.flake = false;
  inputs.src-ansiwave-1_5_0-windows.owner = "ansiwave";
  inputs.src-ansiwave-1_5_0-windows.ref   = "1_5_0-windows";
  inputs.src-ansiwave-1_5_0-windows.repo  = "ansiwave";
  inputs.src-ansiwave-1_5_0-windows.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_5_0-windows"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_5_0-windows";
