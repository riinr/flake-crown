{
  ...
  inputs.src-ansiwave-1_3_2-macos.flake = false;
  inputs.src-ansiwave-1_3_2-macos.ref   = "refs/tags/1.3.2-macos";
  inputs.src-ansiwave-1_3_2-macos.owner = "ansiwave";
  inputs.src-ansiwave-1_3_2-macos.repo  = "ansiwave";
  inputs.src-ansiwave-1_3_2-macos.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_3_2-macos"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_3_2-macos";
