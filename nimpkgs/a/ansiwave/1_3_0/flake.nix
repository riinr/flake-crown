{
  ...
  inputs.src-ansiwave-1_3_0.flake = false;
  inputs.src-ansiwave-1_3_0.ref   = "refs/tags/1.3.0";
  inputs.src-ansiwave-1_3_0.owner = "ansiwave";
  inputs.src-ansiwave-1_3_0.repo  = "ansiwave";
  inputs.src-ansiwave-1_3_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ansiwave-1_3_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ansiwave-1_3_0";
