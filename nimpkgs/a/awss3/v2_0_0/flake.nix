{
  ...
  inputs.src-awsS3-v2_0_0.flake = false;
  inputs.src-awsS3-v2_0_0.ref   = "refs/tags/v2.0.0";
  inputs.src-awsS3-v2_0_0.owner = "ThomasTJdev";
  inputs.src-awsS3-v2_0_0.repo  = "nim_awsS3";
  inputs.src-awsS3-v2_0_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-awsS3-v2_0_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-awsS3-v2_0_0";
