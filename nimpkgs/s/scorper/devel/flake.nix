{
  ...
  inputs.src-scorper-devel.flake = false;
  inputs.src-scorper-devel.ref   = "refs/heads/devel";
  inputs.src-scorper-devel.owner = "bung87";
  inputs.src-scorper-devel.repo  = "scorper";
  inputs.src-scorper-devel.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-scorper-devel"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-scorper-devel";
