{
  ...
  inputs.src-scorper-v1_0_24.ref   = "refs/tags/v1.0.24";
  inputs.src-scorper-v1_0_24.repo  = "scorper";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-scorper-v1_0_24"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-scorper-v1_0_24";
