{
  ...
  inputs.src-scorper-v1_0_3.flake = false;
  inputs.src-scorper-v1_0_3.ref   = "refs/tags/v1.0.3";
  inputs.src-scorper-v1_0_3.owner = "bung87";
  inputs.src-scorper-v1_0_3.repo  = "scorper";
  inputs.src-scorper-v1_0_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-scorper-v1_0_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-scorper-v1_0_3";
