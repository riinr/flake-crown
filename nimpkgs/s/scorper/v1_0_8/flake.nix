{
  ...
  inputs.src-scorper-v1_0_8.flake = false;
  inputs.src-scorper-v1_0_8.ref   = "refs/tags/v1.0.8";
  inputs.src-scorper-v1_0_8.owner = "bung87";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-scorper-v1_0_8"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-scorper-v1_0_8";
