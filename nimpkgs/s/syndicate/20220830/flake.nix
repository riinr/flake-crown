{
  ...
  inputs.src-syndicate-20220830.flake = false;
  inputs.src-syndicate-20220830.ref   = "20220830";
  inputs.src-syndicate-20220830.owner = "~ehmry";
  inputs.src-syndicate-20220830.repo  = "syndicate-nim";
  inputs.src-syndicate-20220830.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-syndicate-20220830"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-syndicate-20220830";
