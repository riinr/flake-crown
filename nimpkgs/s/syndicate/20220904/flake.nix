{
  ...
  inputs.src-syndicate-20220904.flake = false;
  inputs.src-syndicate-20220904.ref   = "20220904";
  inputs.src-syndicate-20220904.owner = "~ehmry";
  inputs.src-syndicate-20220904.repo  = "syndicate-nim";
  inputs.src-syndicate-20220904.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-syndicate-20220904"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-syndicate-20220904";
