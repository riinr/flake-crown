{
  ...
  inputs.src-syndicate-20220627.flake = false;
  inputs.src-syndicate-20220627.ref   = "20220627";
  inputs.src-syndicate-20220627.owner = "~ehmry";
  inputs.src-syndicate-20220627.repo  = "syndicate-nim";
  inputs.src-syndicate-20220627.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-syndicate-20220627"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-syndicate-20220627";
