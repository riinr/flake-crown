{
  ...
  inputs.src-syndicate-1_3_1.flake = false;
  inputs.src-syndicate-1_3_1.ref   = "1.3.1";
  inputs.src-syndicate-1_3_1.owner = "~ehmry";
  inputs.src-syndicate-1_3_1.repo  = "syndicate-nim";
  inputs.src-syndicate-1_3_1.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-syndicate-1_3_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-syndicate-1_3_1";
