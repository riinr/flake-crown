{
  ...
  inputs.src-syndicate-devel.flake = false;
  inputs.src-syndicate-devel.ref   = "devel";
  inputs.src-syndicate-devel.owner = "~ehmry";
  inputs.src-syndicate-devel.repo  = "syndicate-nim";
  inputs.src-syndicate-devel.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-syndicate-devel"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-syndicate-devel";
