{
  ...
  inputs.src-syndicate-1_3_0.flake = false;
  inputs.src-syndicate-1_3_0.ref   = "1.3.0";
  inputs.src-syndicate-1_3_0.owner = "~ehmry";
  inputs.src-syndicate-1_3_0.repo  = "syndicate-nim";
  inputs.src-syndicate-1_3_0.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-syndicate-1_3_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-syndicate-1_3_0";
