{
  ...
  inputs.src-siwin-0_6_1.flake = false;
  inputs.src-siwin-0_6_1.ref   = "refs/tags/0.6.1";
  inputs.src-siwin-0_6_1.owner = "levovix0";
  inputs.src-siwin-0_6_1.repo  = "siwin";
  inputs.src-siwin-0_6_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-siwin-0_6_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-siwin-0_6_1";
