{
  ...
  inputs.src-siwin-0_6_3.flake = false;
  inputs.src-siwin-0_6_3.ref   = "refs/tags/0.6.3";
  inputs.src-siwin-0_6_3.owner = "levovix0";
  inputs.src-siwin-0_6_3.repo  = "siwin";
  inputs.src-siwin-0_6_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-siwin-0_6_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-siwin-0_6_3";
