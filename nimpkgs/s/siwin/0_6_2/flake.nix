{
  ...
  inputs.src-siwin-0_6_2.flake = false;
  inputs.src-siwin-0_6_2.ref   = "refs/tags/0.6.2";
  inputs.src-siwin-0_6_2.owner = "levovix0";
  inputs.src-siwin-0_6_2.repo  = "siwin";
  inputs.src-siwin-0_6_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-siwin-0_6_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-siwin-0_6_2";
