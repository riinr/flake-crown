{
  ...
  inputs.src-strunicode-v0_2_0.flake = false;
  inputs.src-strunicode-v0_2_0.ref   = "refs/tags/v0.2.0";
  inputs.src-strunicode-v0_2_0.owner = "nitely";
  inputs.src-strunicode-v0_2_0.repo  = "nim-strunicode";
  inputs.src-strunicode-v0_2_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-strunicode-v0_2_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-strunicode-v0_2_0";
