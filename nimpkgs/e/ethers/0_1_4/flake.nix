{
  ...
  inputs.src-ethers-0_1_4.flake = false;
  inputs.src-ethers-0_1_4.ref   = "refs/tags/0.1.4";
  inputs.src-ethers-0_1_4.owner = "status-im";
  inputs.src-ethers-0_1_4.repo  = "nim-ethers";
  inputs.src-ethers-0_1_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ethers-0_1_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ethers-0_1_4";
