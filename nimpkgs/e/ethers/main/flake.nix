{
  ...
  inputs.src-ethers-main.flake = false;
  inputs.src-ethers-main.ref   = "refs/heads/main";
  inputs.src-ethers-main.owner = "status-im";
  inputs.src-ethers-main.repo  = "nim-ethers";
  inputs.src-ethers-main.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ethers-main"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ethers-main";
