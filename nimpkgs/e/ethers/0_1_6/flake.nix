{
  ...
  inputs.src-ethers-0_1_6.flake = false;
  inputs.src-ethers-0_1_6.ref   = "refs/tags/0.1.6";
  inputs.src-ethers-0_1_6.owner = "status-im";
  inputs.src-ethers-0_1_6.repo  = "nim-ethers";
  inputs.src-ethers-0_1_6.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ethers-0_1_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ethers-0_1_6";
