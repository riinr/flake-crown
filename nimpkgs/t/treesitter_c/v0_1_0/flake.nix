{
  ...
  inputs.src-treesitter_c-v0_1_0.flake = false;
  inputs.src-treesitter_c-v0_1_0.ref   = "refs/tags/v0.1.0";
  inputs.src-treesitter_c-v0_1_0.owner = "genotrance";
  inputs.src-treesitter_c-v0_1_0.repo  = "nimtreesitter";
    inputs.src-treesitter_c-v0_1_0.dir   = "treesitter_c";
inputs.src-treesitter_c-v0_1_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-treesitter_c-v0_1_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-treesitter_c-v0_1_0";
