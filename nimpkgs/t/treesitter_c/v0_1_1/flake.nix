{
  ...
  inputs.src-treesitter_c-v0_1_1.flake = false;
  inputs.src-treesitter_c-v0_1_1.ref   = "refs/tags/v0.1.1";
  inputs.src-treesitter_c-v0_1_1.owner = "genotrance";
  inputs.src-treesitter_c-v0_1_1.repo  = "nimtreesitter";
    inputs.src-treesitter_c-v0_1_1.dir   = "treesitter_c";
inputs.src-treesitter_c-v0_1_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-treesitter_c-v0_1_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-treesitter_c-v0_1_1";
