{
  ...
  inputs."therapist-v0_2_0".dir   = "v0_2_0";
  inputs."therapist-v0_2_0".owner = "nim-nix-pkgs";
  inputs."therapist-v0_2_0".ref   = "master";
  inputs."therapist-v0_2_0".repo  = "therapist";
  inputs."therapist-v0_2_0".type  = "github";
  inputs."therapist-v0_2_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."therapist-v0_2_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
