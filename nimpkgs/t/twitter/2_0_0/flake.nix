{
  ...
  inputs.src-twitter-2_0_0.flake = false;
  inputs.src-twitter-2_0_0.ref   = "refs/tags/2.0.0";
  inputs.src-twitter-2_0_0.owner = "snus-kin";
  inputs.src-twitter-2_0_0.repo  = "twitter.nim";
  inputs.src-twitter-2_0_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-twitter-2_0_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-twitter-2_0_0";
