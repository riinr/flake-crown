{
  ...
  inputs."toxcore-nim-toxcore-0_5_0".dir   = "nim-toxcore-0_5_0";
  inputs."toxcore-nim-toxcore-0_5_0".owner = "nim-nix-pkgs";
  inputs."toxcore-nim-toxcore-0_5_0".ref   = "master";
  inputs."toxcore-nim-toxcore-0_5_0".repo  = "toxcore";
  inputs."toxcore-nim-toxcore-0_5_0".type  = "github";
  inputs."toxcore-nim-toxcore-0_5_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."toxcore-nim-toxcore-0_5_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
