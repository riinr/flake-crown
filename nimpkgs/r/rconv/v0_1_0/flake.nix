{
  ...
  inputs.src-rconv-v0_1_0.flake = false;
  inputs.src-rconv-v0_1_0.ref   = "refs/tags/v0.1.0";
  inputs.src-rconv-v0_1_0.owner = "prefixaut";
  inputs.src-rconv-v0_1_0.repo  = "rconv";
  inputs.src-rconv-v0_1_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-rconv-v0_1_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-rconv-v0_1_0";
