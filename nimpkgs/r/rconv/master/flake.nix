{
  ...
  inputs.src-rconv-master.flake = false;
  inputs.src-rconv-master.ref   = "refs/heads/master";
  inputs.src-rconv-master.owner = "prefixaut";
  inputs.src-rconv-master.repo  = "rconv";
  inputs.src-rconv-master.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-rconv-master"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-rconv-master";
