{
  ...
  inputs.src-RaytracingAlgorithm-v2_0_0.flake = false;
  inputs.src-RaytracingAlgorithm-v2_0_0.ref   = "refs/tags/v2.0.0";
  inputs.src-RaytracingAlgorithm-v2_0_0.owner = "lorycontixd";
  inputs.src-RaytracingAlgorithm-v2_0_0.repo  = "RaytracingAlgorithm";
  inputs.src-RaytracingAlgorithm-v2_0_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-RaytracingAlgorithm-v2_0_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-RaytracingAlgorithm-v2_0_0";
