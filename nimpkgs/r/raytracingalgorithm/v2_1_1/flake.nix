{
  ...
  inputs.src-RaytracingAlgorithm-v2_1_1.flake = false;
  inputs.src-RaytracingAlgorithm-v2_1_1.ref   = "refs/tags/v2.1.1";
  inputs.src-RaytracingAlgorithm-v2_1_1.owner = "lorycontixd";
  inputs.src-RaytracingAlgorithm-v2_1_1.repo  = "RaytracingAlgorithm";
  inputs.src-RaytracingAlgorithm-v2_1_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-RaytracingAlgorithm-v2_1_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-RaytracingAlgorithm-v2_1_1";
