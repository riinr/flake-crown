{
  ...
  inputs.src-regex-v0_12_0.flake = false;
  inputs.src-regex-v0_12_0.owner = "nitely";
  inputs.src-regex-v0_12_0.ref   = "refs/tags/v0.12.0";
  inputs.src-regex-v0_12_0.repo  = "nim-regex";
  inputs.src-regex-v0_12_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-regex-v0_12_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-regex-v0_12_0";
