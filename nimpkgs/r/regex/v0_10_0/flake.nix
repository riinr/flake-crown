{
  ...
  inputs.src-regex-v0_10_0.flake = false;
  inputs.src-regex-v0_10_0.ref   = "refs/tags/v0.10.0";
  inputs.src-regex-v0_10_0.owner = "nitely";
  inputs.src-regex-v0_10_0.repo  = "nim-regex";
  inputs.src-regex-v0_10_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-regex-v0_10_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-regex-v0_10_0";
