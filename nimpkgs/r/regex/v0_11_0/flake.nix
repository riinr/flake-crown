{
  ...
  inputs.src-regex-v0_11_0.flake = false;
  inputs.src-regex-v0_11_0.ref   = "refs/tags/v0.11.0";
  inputs.src-regex-v0_11_0.owner = "nitely";
  inputs.src-regex-v0_11_0.repo  = "nim-regex";
  inputs.src-regex-v0_11_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-regex-v0_11_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-regex-v0_11_0";
