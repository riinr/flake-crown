{
  ...
  inputs.src-regex-v0_6_0.flake = false;
  inputs.src-regex-v0_6_0.ref   = "refs/tags/v0.6.0";
  inputs.src-regex-v0_6_0.owner = "nitely";
  inputs.src-regex-v0_6_0.repo  = "nim-regex";
  inputs.src-regex-v0_6_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-regex-v0_6_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-regex-v0_6_0";
