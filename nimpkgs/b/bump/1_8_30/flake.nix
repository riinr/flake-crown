{
  ...
  inputs.src-bump-1_8_30.flake = false;
  inputs.src-bump-1_8_30.ref   = "refs/tags/1.8.30";
  inputs.src-bump-1_8_30.owner = "disruptek";
  inputs.src-bump-1_8_30.repo  = "bump";
  inputs.src-bump-1_8_30.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-bump-1_8_30"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-bump-1_8_30";
