{
  ...
  inputs.src-bump-1_8_31.flake = false;
  inputs.src-bump-1_8_31.ref   = "refs/tags/1.8.31";
  inputs.src-bump-1_8_31.owner = "disruptek";
  inputs.src-bump-1_8_31.repo  = "bump";
  inputs.src-bump-1_8_31.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-bump-1_8_31"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-bump-1_8_31";
