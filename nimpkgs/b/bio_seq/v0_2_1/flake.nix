{
  ...
  inputs.src-bioseq-v0_2_1.flake = false;
  inputs.src-bioseq-v0_2_1.ref   = "refs/tags/v0.2.1";
  inputs.src-bioseq-v0_2_1.owner = "kerrycobb";
  inputs.src-bioseq-v0_2_1.repo  = "BioSeq";
  inputs.src-bioseq-v0_2_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-bioseq-v0_2_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-bioseq-v0_2_1";
