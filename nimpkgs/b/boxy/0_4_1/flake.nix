{
  ...
  inputs.src-boxy-0_4_1.flake = false;
  inputs.src-boxy-0_4_1.ref   = "refs/tags/0.4.1";
  inputs.src-boxy-0_4_1.owner = "treeform";
  inputs.src-boxy-0_4_1.repo  = "boxy";
  inputs.src-boxy-0_4_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-boxy-0_4_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-boxy-0_4_1";
