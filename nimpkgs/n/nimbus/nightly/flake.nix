{
  ...
  inputs.src-nimbus-nightly.flake = false;
  inputs.src-nimbus-nightly.ref   = "refs/tags/nightly";
  inputs.src-nimbus-nightly.owner = "status-im";
  inputs.src-nimbus-nightly.repo  = "nimbus";
  inputs.src-nimbus-nightly.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimbus-nightly"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nimbus-nightly";
