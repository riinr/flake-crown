{
  ...
  inputs."nimtest-v0_1_2".dir   = "v0_1_2";
  inputs."nimtest-v0_1_2".owner = "nim-nix-pkgs";
  inputs."nimtest-v0_1_2".ref   = "master";
  inputs."nimtest-v0_1_2".repo  = "nimtest";
  inputs."nimtest-v0_1_2".type  = "github";
  inputs."nimtest-v0_1_2".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nimtest-v0_1_2".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
