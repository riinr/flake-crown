{
  ...
  inputs.src-niprefs-0_3_3.flake = false;
  inputs.src-niprefs-0_3_3.ref   = "refs/tags/0.3.3";
  inputs.src-niprefs-0_3_3.owner = "Patitotective";
  inputs.src-niprefs-0_3_3.repo  = "niprefs";
  inputs.src-niprefs-0_3_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-niprefs-0_3_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-niprefs-0_3_3";
