{
  ...
  inputs.src-niprefs-0_3_1.flake = false;
  inputs.src-niprefs-0_3_1.ref   = "refs/tags/0.3.1";
  inputs.src-niprefs-0_3_1.owner = "Patitotective";
  inputs.src-niprefs-0_3_1.repo  = "niprefs";
  inputs.src-niprefs-0_3_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-niprefs-0_3_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-niprefs-0_3_1";
