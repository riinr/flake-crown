{
  ...
  inputs.src-nexus-v0_1_4_3.flake = false;
  inputs.src-nexus-v0_1_4_3.ref   = "refs/tags/v0.1.4.3";
  inputs.src-nexus-v0_1_4_3.owner = "jfilby";
  inputs.src-nexus-v0_1_4_3.repo  = "nexus";
  inputs.src-nexus-v0_1_4_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nexus-v0_1_4_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nexus-v0_1_4_3";
