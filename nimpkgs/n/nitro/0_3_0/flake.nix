{
  ...
  inputs.src-nitro-0_3_0.flake = false;
  inputs.src-nitro-0_3_0.ref   = "refs/tags/0.3.0";
  inputs.src-nitro-0_3_0.owner = "status-im";
  inputs.src-nitro-0_3_0.repo  = "nim-nitro";
  inputs.src-nitro-0_3_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nitro-0_3_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nitro-0_3_0";
