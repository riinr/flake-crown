{
  ...
  inputs.src-nitro-main.flake = false;
  inputs.src-nitro-main.ref   = "refs/heads/main";
  inputs.src-nitro-main.owner = "status-im";
  inputs.src-nitro-main.repo  = "nim-nitro";
  inputs.src-nitro-main.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nitro-main"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nitro-main";
