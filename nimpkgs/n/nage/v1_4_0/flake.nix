{
  ...
  inputs.src-nage-v1_4_0.flake = false;
  inputs.src-nage-v1_4_0.ref   = "refs/tags/v1.4.0";
  inputs.src-nage-v1_4_0.owner = "acikek";
  inputs.src-nage-v1_4_0.repo  = "nage";
  inputs.src-nage-v1_4_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nage-v1_4_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nage-v1_4_0";
