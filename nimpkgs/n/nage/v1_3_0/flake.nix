{
  ...
  inputs.src-nage-v1_3_0.flake = false;
  inputs.src-nage-v1_3_0.ref   = "refs/tags/v1.3.0";
  inputs.src-nage-v1_3_0.owner = "acikek";
  inputs.src-nage-v1_3_0.repo  = "nage";
  inputs.src-nage-v1_3_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nage-v1_3_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nage-v1_3_0";
