{
  ...
  inputs.src-nage-v1_2_1.flake = false;
  inputs.src-nage-v1_2_1.ref   = "refs/tags/v1.2.1";
  inputs.src-nage-v1_2_1.owner = "acikek";
  inputs.src-nage-v1_2_1.repo  = "nage";
  inputs.src-nage-v1_2_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nage-v1_2_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nage-v1_2_1";
