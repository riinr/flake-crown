{
  ...
  inputs.src-nimgen-v0_5_0.flake = false;
  inputs.src-nimgen-v0_5_0.ref   = "refs/tags/v0.5.0";
  inputs.src-nimgen-v0_5_0.owner = "genotrance";
  inputs.src-nimgen-v0_5_0.repo  = "nimgen";
  inputs.src-nimgen-v0_5_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimgen-v0_5_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nimgen-v0_5_0";
