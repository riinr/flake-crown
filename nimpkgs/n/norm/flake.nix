{
  ...
  inputs."norm-2_5_1".dir   = "2_5_1";
  inputs."norm-2_5_1".owner = "nim-nix-pkgs";
  inputs."norm-2_5_1".ref   = "master";
  inputs."norm-2_5_1".repo  = "norm";
  inputs."norm-2_5_1".type  = "github";
  inputs."norm-2_5_1".inputs.nixpkgs.follows = "nixpkgs";
  inputs."norm-2_5_1".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."norm-2_5_2".dir   = "2_5_2";
  inputs."norm-2_5_2".owner = "nim-nix-pkgs";
  inputs."norm-2_5_2".ref   = "master";
  inputs."norm-2_5_2".repo  = "norm";
  inputs."norm-2_5_2".type  = "github";
  inputs."norm-2_5_2".inputs.nixpkgs.follows = "nixpkgs";
  inputs."norm-2_5_2".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."norm-2_6_0".dir   = "2_6_0";
  inputs."norm-2_6_0".owner = "nim-nix-pkgs";
  inputs."norm-2_6_0".ref   = "master";
  inputs."norm-2_6_0".repo  = "norm";
  inputs."norm-2_6_0".type  = "github";
  inputs."norm-2_6_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."norm-2_6_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
