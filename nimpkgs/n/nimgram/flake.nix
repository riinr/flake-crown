{
  ...
  inputs."nimgram-v0_2_0".dir   = "v0_2_0";
  inputs."nimgram-v0_2_0".owner = "nim-nix-pkgs";
  inputs."nimgram-v0_2_0".ref   = "master";
  inputs."nimgram-v0_2_0".repo  = "nimgram";
  inputs."nimgram-v0_2_0".type  = "github";
  inputs."nimgram-v0_2_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nimgram-v0_2_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
