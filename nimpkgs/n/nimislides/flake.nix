{
  ...
  inputs."nimislides-v0_2".dir   = "v0_2";
  inputs."nimislides-v0_2".owner = "nim-nix-pkgs";
  inputs."nimislides-v0_2".ref   = "master";
  inputs."nimislides-v0_2".repo  = "nimislides";
  inputs."nimislides-v0_2".type  = "github";
  inputs."nimislides-v0_2".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nimislides-v0_2".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."nimislides-v0_2_1".dir   = "v0_2_1";
  inputs."nimislides-v0_2_1".owner = "nim-nix-pkgs";
  inputs."nimislides-v0_2_1".ref   = "master";
  inputs."nimislides-v0_2_1".repo  = "nimislides";
  inputs."nimislides-v0_2_1".type  = "github";
  inputs."nimislides-v0_2_1".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nimislides-v0_2_1".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
