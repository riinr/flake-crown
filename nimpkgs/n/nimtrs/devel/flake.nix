{
  ...
  inputs.src-nimtrs-devel.flake = false;
  inputs.src-nimtrs-devel.ref   = "refs/heads/devel";
  inputs.src-nimtrs-devel.owner = "haxscramper";
  inputs.src-nimtrs-devel.repo  = "nimtrs";
  inputs.src-nimtrs-devel.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimtrs-devel"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nimtrs-devel";
