{
  ...
  inputs.src-norman-2_1_8.flake = false;
  inputs.src-norman-2_1_8.ref   = "refs/tags/2.1.8";
  inputs.src-norman-2_1_8.owner = "moigagoo";
  inputs.src-norman-2_1_8.repo  = "norman";
  inputs.src-norman-2_1_8.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-norman-2_1_8"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-norman-2_1_8";
