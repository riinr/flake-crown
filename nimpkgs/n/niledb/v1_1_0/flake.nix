{
  ...
  inputs.src-niledb-v1_1_0.ref   = "v1_1_0";
  inputs.src-niledb-v1_1_0.repo  = "niledb.git";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-niledb-v1_1_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-niledb-v1_1_0";
