{
  ...
  inputs.src-normalize-v0_2_0.flake = false;
  inputs.src-normalize-v0_2_0.owner = "nitely";
  inputs.src-normalize-v0_2_0.ref   = "v0_2_0";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-normalize-v0_2_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-normalize-v0_2_0";
