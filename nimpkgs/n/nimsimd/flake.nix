{
  ...
  inputs."nimsimd-1_1_7".dir   = "1_1_7";
  inputs."nimsimd-1_1_7".owner = "nim-nix-pkgs";
  inputs."nimsimd-1_1_7".ref   = "master";
  inputs."nimsimd-1_1_7".repo  = "nimsimd";
  inputs."nimsimd-1_1_7".type  = "github";
  inputs."nimsimd-1_1_7".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nimsimd-1_1_7".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."nimsimd-1_1_8".dir   = "1_1_8";
  inputs."nimsimd-1_1_8".owner = "nim-nix-pkgs";
  inputs."nimsimd-1_1_8".ref   = "master";
  inputs."nimsimd-1_1_8".repo  = "nimsimd";
  inputs."nimsimd-1_1_8".type  = "github";
  ...
  inputs."nimsimd-1_2_0".dir   = "1_2_0";
  inputs."nimsimd-1_2_0".owner = "nim-nix-pkgs";
  inputs."nimsimd-1_2_0".ref   = "master";
  inputs."nimsimd-1_2_0".repo  = "nimsimd";
  inputs."nimsimd-1_2_0".type  = "github";
  inputs."nimsimd-1_2_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nimsimd-1_2_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."nimsimd-1_2_1".dir   = "1_2_1";
  inputs."nimsimd-1_2_1".owner = "nim-nix-pkgs";
  inputs."nimsimd-1_2_1".ref   = "master";
  inputs."nimsimd-1_2_1".repo  = "nimsimd";
  inputs."nimsimd-1_2_1".type  = "github";
  inputs."nimsimd-1_2_1".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nimsimd-1_2_1".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
