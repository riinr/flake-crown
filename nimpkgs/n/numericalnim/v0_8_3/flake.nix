{
  ...
  inputs.src-numericalnim-v0_8_3.flake = false;
  inputs.src-numericalnim-v0_8_3.ref   = "refs/tags/v0.8.3";
  inputs.src-numericalnim-v0_8_3.owner = "SciNim";
  inputs.src-numericalnim-v0_8_3.repo  = "numericalnim";
  inputs.src-numericalnim-v0_8_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-numericalnim-v0_8_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-numericalnim-v0_8_3";
