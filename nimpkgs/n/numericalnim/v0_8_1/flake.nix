{
  ...
  inputs.src-numericalnim-v0_8_1.flake = false;
  inputs.src-numericalnim-v0_8_1.ref   = "refs/tags/v0.8.1";
  inputs.src-numericalnim-v0_8_1.owner = "SciNim";
  inputs.src-numericalnim-v0_8_1.repo  = "numericalnim";
  inputs.src-numericalnim-v0_8_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-numericalnim-v0_8_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-numericalnim-v0_8_1";
