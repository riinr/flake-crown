{
  ...
  inputs.src-numericalnim-v0_8_2.flake = false;
  inputs.src-numericalnim-v0_8_2.ref   = "refs/tags/v0.8.2";
  inputs.src-numericalnim-v0_8_2.owner = "SciNim";
  inputs.src-numericalnim-v0_8_2.repo  = "numericalnim";
  inputs.src-numericalnim-v0_8_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-numericalnim-v0_8_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-numericalnim-v0_8_2";
