{
  ...
  inputs.src-nimib-v0_3_0.flake = false;
  inputs.src-nimib-v0_3_0.ref   = "refs/tags/v0.3.0";
  inputs.src-nimib-v0_3_0.owner = "pietroppeter";
  inputs.src-nimib-v0_3_0.repo  = "nimib";
  inputs.src-nimib-v0_3_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimib-v0_3_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nimib-v0_3_0";
