{
  ...
  inputs.src-nimib-v0_2_3.flake = false;
  inputs.src-nimib-v0_2_3.owner = "pietroppeter";
  inputs.src-nimib-v0_2_3.ref   = "refs/tags/v0.2.3";
  inputs.src-nimib-v0_2_3.repo  = "nimib";
  inputs.src-nimib-v0_2_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimib-v0_2_3"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-nimib-v0_2_3";
