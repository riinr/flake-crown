{
  ...
  inputs.src-nimib-v0_3_1.flake = false;
  inputs.src-nimib-v0_3_1.ref   = "refs/tags/v0.3.1";
  inputs.src-nimib-v0_3_1.owner = "pietroppeter";
  inputs.src-nimib-v0_3_1.repo  = "nimib";
  inputs.src-nimib-v0_3_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimib-v0_3_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nimib-v0_3_1";
