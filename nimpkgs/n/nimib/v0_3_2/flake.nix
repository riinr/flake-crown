{
  ...
  inputs.src-nimib-v0_3_2.flake = false;
  inputs.src-nimib-v0_3_2.ref   = "refs/tags/v0.3.2";
  inputs.src-nimib-v0_3_2.owner = "pietroppeter";
  inputs.src-nimib-v0_3_2.repo  = "nimib";
  inputs.src-nimib-v0_3_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimib-v0_3_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nimib-v0_3_2";
