{
  ...
  inputs.src-nimib-v0_3_3.flake = false;
  inputs.src-nimib-v0_3_3.ref   = "refs/tags/v0.3.3";
  inputs.src-nimib-v0_3_3.owner = "pietroppeter";
  inputs.src-nimib-v0_3_3.repo  = "nimib";
  inputs.src-nimib-v0_3_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimib-v0_3_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nimib-v0_3_3";
