{
  ...
  inputs.src-nimib-v0_2_4.flake = false;
  inputs.src-nimib-v0_2_4.owner = "pietroppeter";
  inputs.src-nimib-v0_2_4.ref   = "refs/tags/v0.2.4";
  inputs.src-nimib-v0_2_4.repo  = "nimib";
  inputs.src-nimib-v0_2_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimib-v0_2_4"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-nimib-v0_2_4";
