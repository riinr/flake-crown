{
  ...
  inputs."notificatcher-v0_4_0".dir   = "v0_4_0";
  inputs."notificatcher-v0_4_0".owner = "nim-nix-pkgs";
  inputs."notificatcher-v0_4_0".ref   = "master";
  inputs."notificatcher-v0_4_0".repo  = "notificatcher";
  inputs."notificatcher-v0_4_0".type  = "github";
