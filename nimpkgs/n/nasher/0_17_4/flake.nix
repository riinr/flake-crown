{
  ...
  inputs.src-nasher-0_17_4.flake = false;
  inputs.src-nasher-0_17_4.ref   = "refs/tags/0.17.4";
  inputs.src-nasher-0_17_4.owner = "squattingmonk";
  inputs.src-nasher-0_17_4.repo  = "nasher.nim";
  inputs.src-nasher-0_17_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nasher-0_17_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nasher-0_17_4";
