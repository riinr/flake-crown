{
  ...
  inputs.src-nasher-0_17_3.flake = false;
  inputs.src-nasher-0_17_3.ref   = "refs/tags/0.17.3";
  inputs.src-nasher-0_17_3.owner = "squattingmonk";
  inputs.src-nasher-0_17_3.repo  = "nasher.nim";
  inputs.src-nasher-0_17_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nasher-0_17_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nasher-0_17_3";
