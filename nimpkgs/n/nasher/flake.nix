{
  ...
  inputs."nasher-0_18_0".dir   = "0_18_0";
  inputs."nasher-0_18_0".owner = "nim-nix-pkgs";
  inputs."nasher-0_18_0".ref   = "master";
  inputs."nasher-0_18_0".repo  = "nasher";
  inputs."nasher-0_18_0".type  = "github";
  inputs."nasher-0_18_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nasher-0_18_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."nasher-0_18_1".dir   = "0_18_1";
  inputs."nasher-0_18_1".owner = "nim-nix-pkgs";
  inputs."nasher-0_18_1".ref   = "master";
  inputs."nasher-0_18_1".repo  = "nasher";
  inputs."nasher-0_18_1".type  = "github";
  inputs."nasher-0_18_1".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nasher-0_18_1".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."nasher-0_18_2".dir   = "0_18_2";
  inputs."nasher-0_18_2".owner = "nim-nix-pkgs";
  inputs."nasher-0_18_2".ref   = "master";
  inputs."nasher-0_18_2".repo  = "nasher";
  inputs."nasher-0_18_2".type  = "github";
  inputs."nasher-0_18_2".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nasher-0_18_2".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."nasher-0_19_0".dir   = "0_19_0";
  inputs."nasher-0_19_0".owner = "nim-nix-pkgs";
  inputs."nasher-0_19_0".ref   = "master";
  inputs."nasher-0_19_0".repo  = "nasher";
  inputs."nasher-0_19_0".type  = "github";
  inputs."nasher-0_19_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."nasher-0_19_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
