{
  ...
  inputs.src-nasher-0_9_2.flake = false;
  inputs.src-nasher-0_9_2.owner = "squattingmonk";
  inputs.src-nasher-0_9_2.ref   = "refs/tags/0.9.2";
  inputs.src-nasher-0_9_2.repo  = "nasher.nim";
  inputs.src-nasher-0_9_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nasher-0_9_2"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-nasher-0_9_2";
