{
  ...
  inputs.src-nasher-0_18_0.flake = false;
  inputs.src-nasher-0_18_0.ref   = "refs/tags/0.18.0";
  inputs.src-nasher-0_18_0.owner = "squattingmonk";
  inputs.src-nasher-0_18_0.repo  = "nasher.nim";
  inputs.src-nasher-0_18_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nasher-0_18_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nasher-0_18_0";
