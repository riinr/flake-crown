{
  ...
  inputs.src-nasher-0_18_1.flake = false;
  inputs.src-nasher-0_18_1.ref   = "refs/tags/0.18.1";
  inputs.src-nasher-0_18_1.owner = "squattingmonk";
  inputs.src-nasher-0_18_1.repo  = "nasher.nim";
  inputs.src-nasher-0_18_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nasher-0_18_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nasher-0_18_1";
