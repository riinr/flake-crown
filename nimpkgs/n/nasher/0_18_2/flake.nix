{
  ...
  inputs.src-nasher-0_18_2.flake = false;
  inputs.src-nasher-0_18_2.ref   = "refs/tags/0.18.2";
  inputs.src-nasher-0_18_2.owner = "squattingmonk";
  inputs.src-nasher-0_18_2.repo  = "nasher.nim";
  inputs.src-nasher-0_18_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nasher-0_18_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-nasher-0_18_2";
