{
  ...
  inputs.src-nasher-0_6_0.flake = false;
  inputs.src-nasher-0_6_0.owner = "squattingmonk";
  inputs.src-nasher-0_6_0.ref   = "0_6_0";
  inputs.src-nasher-0_6_0.repo  = "nasher.nim";
  inputs.src-nasher-0_6_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nasher-0_6_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-nasher-0_6_0";
