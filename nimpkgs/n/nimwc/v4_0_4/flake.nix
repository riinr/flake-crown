{
  ...
  inputs.src-nimwc-v4_0_4.flake = false;
  inputs.src-nimwc-v4_0_4.owner = "ThomasTJdev";
  inputs.src-nimwc-v4_0_4.ref   = "refs/tags/v4.0.4";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimwc-v4_0_4"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-nimwc-v4_0_4";
