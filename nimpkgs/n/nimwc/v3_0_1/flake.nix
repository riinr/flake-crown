{
  ...
  inputs.src-nimwc-v3_0_1.flake = false;
  inputs.src-nimwc-v3_0_1.ref   = "refs/tags/v3.0.1";
  inputs.src-nimwc-v3_0_1.owner = "ThomasTJdev";
  inputs.src-nimwc-v3_0_1.repo  = "nim_websitecreator";
  inputs.src-nimwc-v3_0_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-nimwc-v3_0_1"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-nimwc-v3_0_1";
