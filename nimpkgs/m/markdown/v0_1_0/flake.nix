{
  ...
  inputs.src-markdown-v0_1_0.flake = false;
  inputs.src-markdown-v0_1_0.owner = "soasme";
  inputs.src-markdown-v0_1_0.ref   = "v0_1_0";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-markdown-v0_1_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-markdown-v0_1_0";
