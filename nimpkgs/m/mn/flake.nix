{
  ...
  inputs."mn-v0_3_0".dir   = "v0_3_0";
  inputs."mn-v0_3_0".owner = "nim-nix-pkgs";
  inputs."mn-v0_3_0".ref   = "master";
  inputs."mn-v0_3_0".repo  = "mn";
  inputs."mn-v0_3_0".type  = "github";
  inputs."mn-v0_3_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."mn-v0_3_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
