{
  ...
  inputs.src-matext-2022_7_6.flake = false;
  inputs.src-matext-2022_7_6.ref   = "2022.7.6";
  inputs.src-matext-2022_7_6.owner = "~xigoi";
  inputs.src-matext-2022_7_6.repo  = "matext";
  inputs.src-matext-2022_7_6.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-matext-2022_7_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-matext-2022_7_6";
