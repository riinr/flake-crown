{
  ...
  inputs.src-matext-2022_11_9.flake = false;
  inputs.src-matext-2022_11_9.ref   = "2022.11.9";
  inputs.src-matext-2022_11_9.owner = "~xigoi";
  inputs.src-matext-2022_11_9.repo  = "matext";
  inputs.src-matext-2022_11_9.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-matext-2022_11_9"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-matext-2022_11_9";
