{
  ...
  inputs.src-matext-2022_6_27.flake = false;
  inputs.src-matext-2022_6_27.ref   = "2022.6.27";
  inputs.src-matext-2022_6_27.owner = "~xigoi";
  inputs.src-matext-2022_6_27.repo  = "matext";
  inputs.src-matext-2022_6_27.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-matext-2022_6_27"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-matext-2022_6_27";
