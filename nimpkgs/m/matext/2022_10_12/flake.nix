{
  ...
  inputs.src-matext-2022_10_12.flake = false;
  inputs.src-matext-2022_10_12.ref   = "2022.10.12";
  inputs.src-matext-2022_10_12.owner = "~xigoi";
  inputs.src-matext-2022_10_12.repo  = "matext";
  inputs.src-matext-2022_10_12.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-matext-2022_10_12"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-matext-2022_10_12";
