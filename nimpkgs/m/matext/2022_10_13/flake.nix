{
  ...
  inputs.src-matext-2022_10_13.flake = false;
  inputs.src-matext-2022_10_13.ref   = "2022.10.13";
  inputs.src-matext-2022_10_13.owner = "~xigoi";
  inputs.src-matext-2022_10_13.repo  = "matext";
  inputs.src-matext-2022_10_13.type  = "sourcehut";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-matext-2022_10_13"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-matext-2022_10_13";
