{
  ...
  inputs.src-moe-v0_2_5_1.flake = false;
  inputs.src-moe-v0_2_5_1.owner = "fox0430";
  inputs.src-moe-v0_2_5_1.ref   = "refs/tags/v0.2.5.1";
  inputs.src-moe-v0_2_5_1.repo  = "moe";
  inputs.src-moe-v0_2_5_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-moe-v0_2_5_1"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-moe-v0_2_5_1";
