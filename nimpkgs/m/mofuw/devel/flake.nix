{
  ...
  inputs.src-mofuw-devel.flake = false;
  inputs.src-mofuw-devel.ref   = "refs/heads/devel";
  inputs.src-mofuw-devel.owner = "2vg";
  inputs.src-mofuw-devel.repo  = "mofuw";
  inputs.src-mofuw-devel.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-mofuw-devel"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-mofuw-devel";
