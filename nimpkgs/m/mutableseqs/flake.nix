{
  ...
  inputs."mutableseqs-master".dir   = "master";
  inputs."mutableseqs-master".owner = "nim-nix-pkgs";
  inputs."mutableseqs-master".ref   = "master";
  inputs."mutableseqs-master".repo  = "mutableseqs";
