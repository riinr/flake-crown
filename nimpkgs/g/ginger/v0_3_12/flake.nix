{
  ...
  inputs.src-ginger-v0_3_12.flake = false;
  inputs.src-ginger-v0_3_12.ref   = "refs/tags/v0.3.12";
  inputs.src-ginger-v0_3_12.owner = "Vindaar";
  inputs.src-ginger-v0_3_12.repo  = "ginger";
  inputs.src-ginger-v0_3_12.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ginger-v0_3_12"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ginger-v0_3_12";
