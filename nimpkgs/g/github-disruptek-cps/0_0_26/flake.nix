{
  ...
  inputs.src-cps-0_0_26.flake = false;
  inputs.src-cps-0_0_26.ref   = "refs/tags/0.0.26";
  inputs.src-cps-0_0_26.owner = "disruptek";
  inputs.src-cps-0_0_26.repo  = "cps";
  inputs.src-cps-0_0_26.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_26"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_26";
