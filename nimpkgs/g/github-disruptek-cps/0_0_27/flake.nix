{
  ...
  inputs.src-cps-0_0_27.flake = false;
  inputs.src-cps-0_0_27.ref   = "refs/tags/0.0.27";
  inputs.src-cps-0_0_27.owner = "disruptek";
  inputs.src-cps-0_0_27.repo  = "cps";
  inputs.src-cps-0_0_27.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_27"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_27";
