{
  ...
  inputs.src-cps-0_0_34.flake = false;
  inputs.src-cps-0_0_34.ref   = "refs/tags/0.0.34";
  inputs.src-cps-0_0_34.owner = "disruptek";
  inputs.src-cps-0_0_34.repo  = "cps";
  inputs.src-cps-0_0_34.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_34"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_34";
