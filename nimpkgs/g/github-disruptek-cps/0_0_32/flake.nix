{
  ...
  inputs.src-cps-0_0_32.flake = false;
  inputs.src-cps-0_0_32.ref   = "refs/tags/0.0.32";
  inputs.src-cps-0_0_32.owner = "disruptek";
  inputs.src-cps-0_0_32.repo  = "cps";
  inputs.src-cps-0_0_32.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_32"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_32";
