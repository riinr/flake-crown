{
  ...
  inputs.src-cps-0_0_22.flake = false;
  inputs.src-cps-0_0_22.ref   = "refs/tags/0.0.22";
  inputs.src-cps-0_0_22.owner = "disruptek";
  inputs.src-cps-0_0_22.repo  = "cps";
  inputs.src-cps-0_0_22.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_22"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_22";
