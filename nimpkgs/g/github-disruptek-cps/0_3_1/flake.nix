{
  ...
  inputs.src-cps-0_3_1.flake = false;
  inputs.src-cps-0_3_1.ref   = "refs/tags/0.3.1";
  inputs.src-cps-0_3_1.owner = "disruptek";
  inputs.src-cps-0_3_1.repo  = "cps";
  inputs.src-cps-0_3_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_3_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_3_1";
