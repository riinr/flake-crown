{
  ...
  inputs.src-cps-0_0_23.flake = false;
  inputs.src-cps-0_0_23.ref   = "refs/tags/0.0.23";
  inputs.src-cps-0_0_23.owner = "disruptek";
  inputs.src-cps-0_0_23.repo  = "cps";
  inputs.src-cps-0_0_23.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_23"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_23";
