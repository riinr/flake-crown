{
  ...
  inputs.src-cps-0_0_8.flake = false;
  inputs.src-cps-0_0_8.ref   = "refs/tags/0.0.8";
  inputs.src-cps-0_0_8.owner = "disruptek";
  inputs.src-cps-0_0_8.repo  = "cps";
  inputs.src-cps-0_0_8.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_8"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_8";
