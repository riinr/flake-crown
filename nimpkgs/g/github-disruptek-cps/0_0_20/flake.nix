{
  ...
  inputs.src-cps-0_0_20.flake = false;
  inputs.src-cps-0_0_20.ref   = "refs/tags/0.0.20";
  inputs.src-cps-0_0_20.owner = "disruptek";
  inputs.src-cps-0_0_20.repo  = "cps";
  inputs.src-cps-0_0_20.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_20"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_20";
