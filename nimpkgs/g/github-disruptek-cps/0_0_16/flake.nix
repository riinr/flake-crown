{
  ...
  inputs.src-cps-0_0_16.flake = false;
  inputs.src-cps-0_0_16.ref   = "refs/tags/0.0.16";
  inputs.src-cps-0_0_16.owner = "disruptek";
  inputs.src-cps-0_0_16.repo  = "cps";
  inputs.src-cps-0_0_16.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_16"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_16";
