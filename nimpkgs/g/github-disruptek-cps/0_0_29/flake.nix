{
  ...
  inputs.src-cps-0_0_29.flake = false;
  inputs.src-cps-0_0_29.ref   = "refs/tags/0.0.29";
  inputs.src-cps-0_0_29.owner = "disruptek";
  inputs.src-cps-0_0_29.repo  = "cps";
  inputs.src-cps-0_0_29.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_29"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_29";
