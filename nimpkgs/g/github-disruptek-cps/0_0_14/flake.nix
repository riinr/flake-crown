{
  ...
  inputs.src-cps-0_0_14.flake = false;
  inputs.src-cps-0_0_14.ref   = "refs/tags/0.0.14";
  inputs.src-cps-0_0_14.owner = "disruptek";
  inputs.src-cps-0_0_14.repo  = "cps";
  inputs.src-cps-0_0_14.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_14"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_14";
