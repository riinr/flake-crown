{
  ...
  inputs.src-cps-0_0_35.flake = false;
  inputs.src-cps-0_0_35.ref   = "refs/tags/0.0.35";
  inputs.src-cps-0_0_35.owner = "disruptek";
  inputs.src-cps-0_0_35.repo  = "cps";
  inputs.src-cps-0_0_35.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_35"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_35";
