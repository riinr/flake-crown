{
  ...
  inputs.src-cps-0_4_4.flake = false;
  inputs.src-cps-0_4_4.ref   = "refs/tags/0.4.4";
  inputs.src-cps-0_4_4.owner = "disruptek";
  inputs.src-cps-0_4_4.repo  = "cps";
  inputs.src-cps-0_4_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_4_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_4_4";
