{
  ...
  inputs.src-cps-0_0_12.flake = false;
  inputs.src-cps-0_0_12.ref   = "refs/tags/0.0.12";
  inputs.src-cps-0_0_12.owner = "disruptek";
  inputs.src-cps-0_0_12.repo  = "cps";
  inputs.src-cps-0_0_12.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_12"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_12";
