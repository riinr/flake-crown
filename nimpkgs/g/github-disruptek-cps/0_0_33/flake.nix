{
  ...
  inputs.src-cps-0_0_33.flake = false;
  inputs.src-cps-0_0_33.ref   = "refs/tags/0.0.33";
  inputs.src-cps-0_0_33.owner = "disruptek";
  inputs.src-cps-0_0_33.repo  = "cps";
  inputs.src-cps-0_0_33.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_33"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_33";
