{
  ...
  inputs.src-cps-0_0_19.flake = false;
  inputs.src-cps-0_0_19.ref   = "refs/tags/0.0.19";
  inputs.src-cps-0_0_19.owner = "disruptek";
  inputs.src-cps-0_0_19.repo  = "cps";
  inputs.src-cps-0_0_19.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_19"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_19";
