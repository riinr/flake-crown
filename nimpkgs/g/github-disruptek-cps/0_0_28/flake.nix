{
  ...
  inputs.src-cps-0_0_28.flake = false;
  inputs.src-cps-0_0_28.ref   = "refs/tags/0.0.28";
  inputs.src-cps-0_0_28.owner = "disruptek";
  inputs.src-cps-0_0_28.repo  = "cps";
  inputs.src-cps-0_0_28.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_28"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_28";
