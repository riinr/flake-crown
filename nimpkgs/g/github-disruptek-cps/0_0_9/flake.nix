{
  ...
  inputs.src-cps-0_0_9.flake = false;
  inputs.src-cps-0_0_9.ref   = "refs/tags/0.0.9";
  inputs.src-cps-0_0_9.owner = "disruptek";
  inputs.src-cps-0_0_9.repo  = "cps";
  inputs.src-cps-0_0_9.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_9"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_9";
