{
  ...
  inputs.src-cps-0_0_25.flake = false;
  inputs.src-cps-0_0_25.ref   = "refs/tags/0.0.25";
  inputs.src-cps-0_0_25.owner = "disruptek";
  inputs.src-cps-0_0_25.repo  = "cps";
  inputs.src-cps-0_0_25.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_25"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_25";
