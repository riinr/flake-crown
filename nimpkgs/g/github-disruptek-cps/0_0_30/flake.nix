{
  ...
  inputs.src-cps-0_0_30.flake = false;
  inputs.src-cps-0_0_30.ref   = "refs/tags/0.0.30";
  inputs.src-cps-0_0_30.owner = "disruptek";
  inputs.src-cps-0_0_30.repo  = "cps";
  inputs.src-cps-0_0_30.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_30"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_30";
