{
  ...
  inputs.src-cps-0_0_15.flake = false;
  inputs.src-cps-0_0_15.ref   = "refs/tags/0.0.15";
  inputs.src-cps-0_0_15.owner = "disruptek";
  inputs.src-cps-0_0_15.repo  = "cps";
  inputs.src-cps-0_0_15.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_15"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_15";
