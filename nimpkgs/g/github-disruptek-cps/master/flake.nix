{
  ...
  inputs.src-cps-master.flake = false;
  inputs.src-cps-master.ref   = "refs/heads/master";
  inputs.src-cps-master.owner = "disruptek";
  inputs.src-cps-master.repo  = "cps";
  inputs.src-cps-master.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-master"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-master";
