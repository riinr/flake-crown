{
  ...
  inputs.src-cps-0_4_3.flake = false;
  inputs.src-cps-0_4_3.ref   = "refs/tags/0.4.3";
  inputs.src-cps-0_4_3.owner = "disruptek";
  inputs.src-cps-0_4_3.repo  = "cps";
  inputs.src-cps-0_4_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_4_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_4_3";
