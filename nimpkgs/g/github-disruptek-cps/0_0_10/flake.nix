{
  ...
  inputs.src-cps-0_0_10.flake = false;
  inputs.src-cps-0_0_10.ref   = "refs/tags/0.0.10";
  inputs.src-cps-0_0_10.owner = "disruptek";
  inputs.src-cps-0_0_10.repo  = "cps";
  inputs.src-cps-0_0_10.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_10"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_10";
