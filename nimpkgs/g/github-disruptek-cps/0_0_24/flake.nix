{
  ...
  inputs.src-cps-0_0_24.flake = false;
  inputs.src-cps-0_0_24.ref   = "refs/tags/0.0.24";
  inputs.src-cps-0_0_24.owner = "disruptek";
  inputs.src-cps-0_0_24.repo  = "cps";
  inputs.src-cps-0_0_24.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_24"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_24";
