{
  ...
  inputs.src-cps-0_0_18.flake = false;
  inputs.src-cps-0_0_18.ref   = "refs/tags/0.0.18";
  inputs.src-cps-0_0_18.owner = "disruptek";
  inputs.src-cps-0_0_18.repo  = "cps";
  inputs.src-cps-0_0_18.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_0_18"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_0_18";
