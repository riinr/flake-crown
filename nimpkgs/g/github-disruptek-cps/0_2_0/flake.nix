{
  ...
  inputs.src-cps-0_2_0.flake = false;
  inputs.src-cps-0_2_0.ref   = "refs/tags/0.2.0";
  inputs.src-cps-0_2_0.owner = "disruptek";
  inputs.src-cps-0_2_0.repo  = "cps";
  inputs.src-cps-0_2_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cps-0_2_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cps-0_2_0";
