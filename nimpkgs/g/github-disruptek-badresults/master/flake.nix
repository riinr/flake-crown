{
  ...
  inputs.src-badresults-master.flake = false;
  inputs.src-badresults-master.ref   = "refs/heads/master";
  inputs.src-badresults-master.owner = "disruptek";
  inputs.src-badresults-master.repo  = "badresults";
  inputs.src-badresults-master.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-badresults-master"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-badresults-master";
