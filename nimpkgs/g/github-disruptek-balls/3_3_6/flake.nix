{
  ...
  inputs.src-balls-3_3_6.flake = false;
  inputs.src-balls-3_3_6.ref   = "refs/tags/3.3.6";
  inputs.src-balls-3_3_6.owner = "disruptek";
  inputs.src-balls-3_3_6.repo  = "balls";
  inputs.src-balls-3_3_6.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-3_3_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-3_3_6";
