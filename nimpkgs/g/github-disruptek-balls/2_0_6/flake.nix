{
  ...
  inputs.src-balls-2_0_6.flake = false;
  inputs.src-balls-2_0_6.ref   = "refs/tags/2.0.6";
  inputs.src-balls-2_0_6.owner = "disruptek";
  inputs.src-balls-2_0_6.repo  = "balls";
  inputs.src-balls-2_0_6.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-2_0_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-2_0_6";
