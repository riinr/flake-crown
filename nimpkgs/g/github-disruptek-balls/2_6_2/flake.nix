{
  ...
  inputs.src-balls-2_6_2.flake = false;
  inputs.src-balls-2_6_2.ref   = "refs/tags/2.6.2";
  inputs.src-balls-2_6_2.owner = "disruptek";
  inputs.src-balls-2_6_2.repo  = "balls";
  inputs.src-balls-2_6_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-2_6_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-2_6_2";
