{
  ...
  inputs.src-balls-3_2_0.flake = false;
  inputs.src-balls-3_2_0.ref   = "refs/tags/3.2.0";
  inputs.src-balls-3_2_0.owner = "disruptek";
  inputs.src-balls-3_2_0.repo  = "balls";
  inputs.src-balls-3_2_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-3_2_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-3_2_0";
