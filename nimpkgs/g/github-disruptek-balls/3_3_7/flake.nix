{
  ...
  inputs.src-balls-3_3_7.flake = false;
  inputs.src-balls-3_3_7.ref   = "refs/tags/3.3.7";
  inputs.src-balls-3_3_7.owner = "disruptek";
  inputs.src-balls-3_3_7.repo  = "balls";
  inputs.src-balls-3_3_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-3_3_7"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-3_3_7";
