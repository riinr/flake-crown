{
  ...
  inputs.src-balls-2_5_4.flake = false;
  inputs.src-balls-2_5_4.ref   = "refs/tags/2.5.4";
  inputs.src-balls-2_5_4.owner = "disruptek";
  inputs.src-balls-2_5_4.repo  = "balls";
  inputs.src-balls-2_5_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-2_5_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-2_5_4";
