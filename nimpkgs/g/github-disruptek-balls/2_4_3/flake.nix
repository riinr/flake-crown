{
  ...
  inputs.src-balls-2_4_3.flake = false;
  inputs.src-balls-2_4_3.ref   = "refs/tags/2.4.3";
  inputs.src-balls-2_4_3.owner = "disruptek";
  inputs.src-balls-2_4_3.repo  = "balls";
  inputs.src-balls-2_4_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-2_4_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-2_4_3";
