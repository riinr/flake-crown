{
  ...
  inputs.src-balls-2_0_1.flake = false;
  inputs.src-balls-2_0_1.ref   = "refs/tags/2.0.1";
  inputs.src-balls-2_0_1.owner = "disruptek";
  inputs.src-balls-2_0_1.repo  = "balls";
  inputs.src-balls-2_0_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-2_0_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-2_0_1";
