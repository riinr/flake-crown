{
  ...
  inputs.src-balls-3_3_4.flake = false;
  inputs.src-balls-3_3_4.ref   = "refs/tags/3.3.4";
  inputs.src-balls-3_3_4.owner = "disruptek";
  inputs.src-balls-3_3_4.repo  = "balls";
  inputs.src-balls-3_3_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-3_3_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-3_3_4";
