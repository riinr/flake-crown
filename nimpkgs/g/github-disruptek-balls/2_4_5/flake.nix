{
  ...
  inputs.src-balls-2_4_5.flake = false;
  inputs.src-balls-2_4_5.ref   = "refs/tags/2.4.5";
  inputs.src-balls-2_4_5.owner = "disruptek";
  inputs.src-balls-2_4_5.repo  = "balls";
  inputs.src-balls-2_4_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-2_4_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-2_4_5";
