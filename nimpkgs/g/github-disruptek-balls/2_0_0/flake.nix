{
  ...
  inputs.src-balls-2_0_0.flake = false;
  inputs.src-balls-2_0_0.ref   = "refs/tags/2.0.0";
  inputs.src-balls-2_0_0.owner = "disruptek";
  inputs.src-balls-2_0_0.repo  = "balls";
  inputs.src-balls-2_0_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-balls-2_0_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-balls-2_0_0";
