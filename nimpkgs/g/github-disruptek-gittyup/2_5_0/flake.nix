{
  ...
  inputs.src-gittyup-2_5_0.flake = false;
  inputs.src-gittyup-2_5_0.ref   = "refs/tags/2.5.0";
  inputs.src-gittyup-2_5_0.owner = "disruptek";
  inputs.src-gittyup-2_5_0.repo  = "gittyup";
  inputs.src-gittyup-2_5_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_5_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_5_0";
