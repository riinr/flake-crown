{
  ...
  inputs.src-gittyup-2_1_8.flake = false;
  inputs.src-gittyup-2_1_8.ref   = "refs/tags/2.1.8";
  inputs.src-gittyup-2_1_8.owner = "disruptek";
  inputs.src-gittyup-2_1_8.repo  = "gittyup";
  inputs.src-gittyup-2_1_8.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_1_8"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_1_8";
