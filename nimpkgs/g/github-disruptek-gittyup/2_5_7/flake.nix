{
  ...
  inputs.src-gittyup-2_5_7.flake = false;
  inputs.src-gittyup-2_5_7.ref   = "refs/tags/2.5.7";
  inputs.src-gittyup-2_5_7.owner = "disruptek";
  inputs.src-gittyup-2_5_7.repo  = "gittyup";
  inputs.src-gittyup-2_5_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_5_7"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_5_7";
