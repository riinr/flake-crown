{
  ...
  inputs.src-gittyup-1_0_2.flake = false;
  inputs.src-gittyup-1_0_2.ref   = "refs/tags/1.0.2";
  inputs.src-gittyup-1_0_2.owner = "disruptek";
  inputs.src-gittyup-1_0_2.repo  = "gittyup";
  inputs.src-gittyup-1_0_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-1_0_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-1_0_2";
