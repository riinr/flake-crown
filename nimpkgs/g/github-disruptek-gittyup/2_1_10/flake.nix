{
  ...
  inputs.src-gittyup-2_1_10.flake = false;
  inputs.src-gittyup-2_1_10.ref   = "refs/tags/2.1.10";
  inputs.src-gittyup-2_1_10.owner = "disruptek";
  inputs.src-gittyup-2_1_10.repo  = "gittyup";
  inputs.src-gittyup-2_1_10.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_1_10"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_1_10";
