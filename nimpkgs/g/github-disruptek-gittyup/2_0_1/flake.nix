{
  ...
  inputs.src-gittyup-2_0_1.flake = false;
  inputs.src-gittyup-2_0_1.ref   = "refs/tags/2.0.1";
  inputs.src-gittyup-2_0_1.owner = "disruptek";
  inputs.src-gittyup-2_0_1.repo  = "gittyup";
  inputs.src-gittyup-2_0_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_0_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_0_1";
