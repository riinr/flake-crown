{
  ...
  inputs.src-gittyup-1_0_6.flake = false;
  inputs.src-gittyup-1_0_6.ref   = "refs/tags/1.0.6";
  inputs.src-gittyup-1_0_6.owner = "disruptek";
  inputs.src-gittyup-1_0_6.repo  = "gittyup";
  inputs.src-gittyup-1_0_6.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-1_0_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-1_0_6";
