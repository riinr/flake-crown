{
  ...
  inputs.src-gittyup-2_1_5.flake = false;
  inputs.src-gittyup-2_1_5.ref   = "refs/tags/2.1.5";
  inputs.src-gittyup-2_1_5.owner = "disruptek";
  inputs.src-gittyup-2_1_5.repo  = "gittyup";
  inputs.src-gittyup-2_1_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_1_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_1_5";
