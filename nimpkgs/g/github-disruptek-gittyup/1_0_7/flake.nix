{
  ...
  inputs.src-gittyup-1_0_7.flake = false;
  inputs.src-gittyup-1_0_7.ref   = "refs/tags/1.0.7";
  inputs.src-gittyup-1_0_7.owner = "disruptek";
  inputs.src-gittyup-1_0_7.repo  = "gittyup";
  inputs.src-gittyup-1_0_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-1_0_7"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-1_0_7";
