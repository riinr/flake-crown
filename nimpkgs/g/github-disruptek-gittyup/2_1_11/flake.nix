{
  ...
  inputs.src-gittyup-2_1_11.flake = false;
  inputs.src-gittyup-2_1_11.ref   = "refs/tags/2.1.11";
  inputs.src-gittyup-2_1_11.owner = "disruptek";
  inputs.src-gittyup-2_1_11.repo  = "gittyup";
  inputs.src-gittyup-2_1_11.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_1_11"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_1_11";
