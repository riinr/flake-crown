{
  ...
  inputs.src-gittyup-2_5_9.flake = false;
  inputs.src-gittyup-2_5_9.ref   = "refs/tags/2.5.9";
  inputs.src-gittyup-2_5_9.owner = "disruptek";
  inputs.src-gittyup-2_5_9.repo  = "gittyup";
  inputs.src-gittyup-2_5_9.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_5_9"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_5_9";
