{
  ...
  inputs.src-gittyup-2_1_6.flake = false;
  inputs.src-gittyup-2_1_6.ref   = "refs/tags/2.1.6";
  inputs.src-gittyup-2_1_6.owner = "disruptek";
  inputs.src-gittyup-2_1_6.repo  = "gittyup";
  inputs.src-gittyup-2_1_6.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_1_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_1_6";
