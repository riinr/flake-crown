{
  ...
  inputs.src-gittyup-2_1_14.flake = false;
  inputs.src-gittyup-2_1_14.ref   = "refs/tags/2.1.14";
  inputs.src-gittyup-2_1_14.owner = "disruptek";
  inputs.src-gittyup-2_1_14.repo  = "gittyup";
  inputs.src-gittyup-2_1_14.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_1_14"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_1_14";
