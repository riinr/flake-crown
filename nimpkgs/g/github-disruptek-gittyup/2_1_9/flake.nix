{
  ...
  inputs.src-gittyup-2_1_9.flake = false;
  inputs.src-gittyup-2_1_9.ref   = "refs/tags/2.1.9";
  inputs.src-gittyup-2_1_9.owner = "disruptek";
  inputs.src-gittyup-2_1_9.repo  = "gittyup";
  inputs.src-gittyup-2_1_9.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_1_9"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_1_9";
