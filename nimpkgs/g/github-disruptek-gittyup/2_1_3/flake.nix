{
  ...
  inputs.src-gittyup-2_1_3.flake = false;
  inputs.src-gittyup-2_1_3.ref   = "refs/tags/2.1.3";
  inputs.src-gittyup-2_1_3.owner = "disruptek";
  inputs.src-gittyup-2_1_3.repo  = "gittyup";
  inputs.src-gittyup-2_1_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_1_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_1_3";
