{
  ...
  inputs.src-gittyup-2_1_13.flake = false;
  inputs.src-gittyup-2_1_13.ref   = "refs/tags/2.1.13";
  inputs.src-gittyup-2_1_13.owner = "disruptek";
  inputs.src-gittyup-2_1_13.repo  = "gittyup";
  inputs.src-gittyup-2_1_13.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_1_13"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_1_13";
