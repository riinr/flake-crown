{
  ...
  inputs.src-gittyup-2_4_1.flake = false;
  inputs.src-gittyup-2_4_1.ref   = "refs/tags/2.4.1";
  inputs.src-gittyup-2_4_1.owner = "disruptek";
  inputs.src-gittyup-2_4_1.repo  = "gittyup";
  inputs.src-gittyup-2_4_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-gittyup-2_4_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-gittyup-2_4_1";
