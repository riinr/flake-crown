{
  ...
  inputs.src-union-0_1_0.flake = false;
  inputs.src-union-0_1_0.ref   = "refs/tags/0.1.0";
  inputs.src-union-0_1_0.owner = "alaviss";
  inputs.src-union-0_1_0.repo  = "union";
  inputs.src-union-0_1_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-union-0_1_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-union-0_1_0";
