{
  ...
  inputs.src-union-0_1_1.flake = false;
  inputs.src-union-0_1_1.ref   = "refs/tags/0.1.1";
  inputs.src-union-0_1_1.owner = "alaviss";
  inputs.src-union-0_1_1.repo  = "union";
  inputs.src-union-0_1_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-union-0_1_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-union-0_1_1";
