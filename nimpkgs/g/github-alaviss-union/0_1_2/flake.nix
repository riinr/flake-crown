{
  ...
  inputs.src-union-0_1_2.flake = false;
  inputs.src-union-0_1_2.ref   = "refs/tags/0.1.2";
  inputs.src-union-0_1_2.owner = "alaviss";
  inputs.src-union-0_1_2.repo  = "union";
  inputs.src-union-0_1_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-union-0_1_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-union-0_1_2";
