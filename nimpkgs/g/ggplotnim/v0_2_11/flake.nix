{
  ...
  inputs.src-ggplotnim-v0_2_11.flake = false;
  inputs.src-ggplotnim-v0_2_11.ref   = "refs/tags/v0.2.11";
  inputs.src-ggplotnim-v0_2_11.owner = "Vindaar";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ggplotnim-v0_2_11"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ggplotnim-v0_2_11";
