{
  ...
  inputs.src-ggplotnim-v0_2_7.flake = false;
  inputs.src-ggplotnim-v0_2_7.ref   = "refs/tags/v0.2.7";
  inputs.src-ggplotnim-v0_2_7.owner = "Vindaar";
  inputs.src-ggplotnim-v0_2_7.repo  = "ggplotnim";
  inputs.src-ggplotnim-v0_2_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ggplotnim-v0_2_7"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ggplotnim-v0_2_7";
