{
  ...
  inputs.src-ggplotnim-v0_5_5.flake = false;
  inputs.src-ggplotnim-v0_5_5.ref   = "refs/tags/v0.5.5";
  inputs.src-ggplotnim-v0_5_5.owner = "Vindaar";
  inputs.src-ggplotnim-v0_5_5.repo  = "ggplotnim";
  inputs.src-ggplotnim-v0_5_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ggplotnim-v0_5_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ggplotnim-v0_5_5";
