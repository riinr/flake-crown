{
  ...
  inputs.src-ggplotnim-v0_5_8.flake = false;
  inputs.src-ggplotnim-v0_5_8.ref   = "refs/tags/v0.5.8";
  inputs.src-ggplotnim-v0_5_8.owner = "Vindaar";
  inputs.src-ggplotnim-v0_5_8.repo  = "ggplotnim";
  inputs.src-ggplotnim-v0_5_8.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ggplotnim-v0_5_8"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ggplotnim-v0_5_8";
