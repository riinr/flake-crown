{
  ...
  inputs.src-ggplotnim-v0_3_6.flake = false;
  inputs.src-ggplotnim-v0_3_6.ref   = "refs/tags/v0.3.6";
  inputs.src-ggplotnim-v0_3_6.owner = "Vindaar";
  inputs.src-ggplotnim-v0_3_6.repo  = "ggplotnim";
  inputs.src-ggplotnim-v0_3_6.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ggplotnim-v0_3_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ggplotnim-v0_3_6";
