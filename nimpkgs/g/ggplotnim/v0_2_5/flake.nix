{
  ...
  inputs.src-ggplotnim-v0_2_5.flake = false;
  inputs.src-ggplotnim-v0_2_5.ref   = "refs/tags/v0.2.5";
  inputs.src-ggplotnim-v0_2_5.owner = "Vindaar";
  inputs.src-ggplotnim-v0_2_5.repo  = "ggplotnim";
  inputs.src-ggplotnim-v0_2_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ggplotnim-v0_2_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ggplotnim-v0_2_5";
