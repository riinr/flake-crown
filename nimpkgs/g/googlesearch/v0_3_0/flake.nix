{
  ...
  inputs.src-googlesearch-v0_3_0.flake = false;
  inputs.src-googlesearch-v0_3_0.owner = "xyb";
  inputs.src-googlesearch-v0_3_0.ref   = "v0_3_0";
  inputs.src-googlesearch-v0_3_0.repo  = "googlesearch.nim";
  inputs.src-googlesearch-v0_3_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-googlesearch-v0_3_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-googlesearch-v0_3_0";
