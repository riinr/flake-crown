{
  ...
  inputs.src-golden-2_5_2.ref   = "refs/tags/2.5.2";
  inputs.src-golden-2_5_2.repo  = "golden";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-golden-2_5_2"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-golden-2_5_2";
