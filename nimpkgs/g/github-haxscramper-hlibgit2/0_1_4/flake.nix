{
  ...
  inputs.src-hlibgit2-0_1_4.flake = false;
  inputs.src-hlibgit2-0_1_4.ref   = "refs/tags/0.1.4";
  inputs.src-hlibgit2-0_1_4.owner = "haxscramper";
  inputs.src-hlibgit2-0_1_4.repo  = "hlibgit2";
  inputs.src-hlibgit2-0_1_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-hlibgit2-0_1_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-hlibgit2-0_1_4";
