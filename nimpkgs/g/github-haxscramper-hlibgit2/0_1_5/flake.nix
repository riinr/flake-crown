{
  ...
  inputs.src-hlibgit2-0_1_5.flake = false;
  inputs.src-hlibgit2-0_1_5.ref   = "refs/tags/0.1.5";
  inputs.src-hlibgit2-0_1_5.owner = "haxscramper";
  inputs.src-hlibgit2-0_1_5.repo  = "hlibgit2";
  inputs.src-hlibgit2-0_1_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-hlibgit2-0_1_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-hlibgit2-0_1_5";
