{
  ...
  inputs.src-assume-0_0_2.flake = false;
  inputs.src-assume-0_0_2.ref   = "refs/tags/0.0.2";
  inputs.src-assume-0_0_2.owner = "disruptek";
  inputs.src-assume-0_0_2.repo  = "assume";
  inputs.src-assume-0_0_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-assume-0_0_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-assume-0_0_2";
