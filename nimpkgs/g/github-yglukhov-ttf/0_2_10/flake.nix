{
  ...
  inputs.src-ttf-0_2_10.flake = false;
  inputs.src-ttf-0_2_10.ref   = "refs/tags/0.2.10";
  inputs.src-ttf-0_2_10.owner = "yglukhov";
  inputs.src-ttf-0_2_10.repo  = "ttf";
  inputs.src-ttf-0_2_10.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ttf-0_2_10"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ttf-0_2_10";
