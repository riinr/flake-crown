{
  ...
  inputs.src-ttf-v0_2.flake = false;
  inputs.src-ttf-v0_2.ref   = "refs/tags/v0.2";
  inputs.src-ttf-v0_2.owner = "yglukhov";
  inputs.src-ttf-v0_2.repo  = "ttf";
  inputs.src-ttf-v0_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ttf-v0_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ttf-v0_2";
