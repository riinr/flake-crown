{
  ...
  inputs.src-ttf-0_2_5.flake = false;
  inputs.src-ttf-0_2_5.ref   = "refs/tags/0.2.5";
  inputs.src-ttf-0_2_5.owner = "yglukhov";
  inputs.src-ttf-0_2_5.repo  = "ttf";
  inputs.src-ttf-0_2_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ttf-0_2_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ttf-0_2_5";
