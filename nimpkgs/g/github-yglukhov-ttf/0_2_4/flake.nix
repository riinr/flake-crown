{
  ...
  inputs.src-ttf-0_2_4.flake = false;
  inputs.src-ttf-0_2_4.ref   = "refs/tags/0.2.4";
  inputs.src-ttf-0_2_4.owner = "yglukhov";
  inputs.src-ttf-0_2_4.repo  = "ttf";
  inputs.src-ttf-0_2_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ttf-0_2_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ttf-0_2_4";
