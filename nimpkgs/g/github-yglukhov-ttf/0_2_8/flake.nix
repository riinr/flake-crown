{
  ...
  inputs.src-ttf-0_2_8.flake = false;
  inputs.src-ttf-0_2_8.ref   = "refs/tags/0.2.8";
  inputs.src-ttf-0_2_8.owner = "yglukhov";
  inputs.src-ttf-0_2_8.repo  = "ttf";
  inputs.src-ttf-0_2_8.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ttf-0_2_8"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ttf-0_2_8";
