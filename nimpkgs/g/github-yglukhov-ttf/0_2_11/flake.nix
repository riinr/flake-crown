{
  ...
  inputs.src-ttf-0_2_11.flake = false;
  inputs.src-ttf-0_2_11.ref   = "refs/tags/0.2.11";
  inputs.src-ttf-0_2_11.owner = "yglukhov";
  inputs.src-ttf-0_2_11.repo  = "ttf";
  inputs.src-ttf-0_2_11.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ttf-0_2_11"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ttf-0_2_11";
