{
  ...
  inputs.src-ttf-0_2_9.flake = false;
  inputs.src-ttf-0_2_9.ref   = "refs/tags/0.2.9";
  inputs.src-ttf-0_2_9.owner = "yglukhov";
  inputs.src-ttf-0_2_9.repo  = "ttf";
  inputs.src-ttf-0_2_9.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ttf-0_2_9"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ttf-0_2_9";
