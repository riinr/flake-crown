{
  ...
  inputs.src-ttf-0_2_2.flake = false;
  inputs.src-ttf-0_2_2.ref   = "refs/tags/0.2.2";
  inputs.src-ttf-0_2_2.owner = "yglukhov";
  inputs.src-ttf-0_2_2.repo  = "ttf";
  inputs.src-ttf-0_2_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ttf-0_2_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ttf-0_2_2";
