{
  ...
  inputs.src-ttf-0_2_7.flake = false;
  inputs.src-ttf-0_2_7.ref   = "refs/tags/0.2.7";
  inputs.src-ttf-0_2_7.owner = "yglukhov";
  inputs.src-ttf-0_2_7.repo  = "ttf";
  inputs.src-ttf-0_2_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ttf-0_2_7"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ttf-0_2_7";
