{
  ...
  inputs.src-ttf-master.flake = false;
  inputs.src-ttf-master.ref   = "refs/heads/master";
  inputs.src-ttf-master.owner = "yglukhov";
  inputs.src-ttf-master.repo  = "ttf";
  inputs.src-ttf-master.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-ttf-master"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-ttf-master";
