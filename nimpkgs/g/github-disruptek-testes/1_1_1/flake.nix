{
  ...
  inputs.src-testes-1_1_1.flake = false;
  inputs.src-testes-1_1_1.ref   = "refs/tags/1.1.1";
  inputs.src-testes-1_1_1.owner = "disruptek";
  inputs.src-testes-1_1_1.repo  = "testes";
  inputs.src-testes-1_1_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-1_1_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-1_1_1";
