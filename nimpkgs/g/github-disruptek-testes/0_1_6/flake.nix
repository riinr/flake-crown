{
  ...
  inputs.src-testes-0_1_6.flake = false;
  inputs.src-testes-0_1_6.ref   = "refs/tags/0.1.6";
  inputs.src-testes-0_1_6.owner = "disruptek";
  inputs.src-testes-0_1_6.repo  = "testes";
  inputs.src-testes-0_1_6.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_1_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_1_6";
