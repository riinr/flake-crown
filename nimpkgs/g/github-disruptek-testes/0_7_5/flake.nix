{
  ...
  inputs.src-testes-0_7_5.flake = false;
  inputs.src-testes-0_7_5.ref   = "refs/tags/0.7.5";
  inputs.src-testes-0_7_5.owner = "disruptek";
  inputs.src-testes-0_7_5.repo  = "testes";
  inputs.src-testes-0_7_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_7_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_7_5";
