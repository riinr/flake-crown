{
  ...
  inputs.src-testes-0_7_8.flake = false;
  inputs.src-testes-0_7_8.ref   = "refs/tags/0.7.8";
  inputs.src-testes-0_7_8.owner = "disruptek";
  inputs.src-testes-0_7_8.repo  = "testes";
  inputs.src-testes-0_7_8.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_7_8"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_7_8";
