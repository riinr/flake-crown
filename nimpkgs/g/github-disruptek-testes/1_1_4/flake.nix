{
  ...
  inputs.src-testes-1_1_4.flake = false;
  inputs.src-testes-1_1_4.ref   = "refs/tags/1.1.4";
  inputs.src-testes-1_1_4.owner = "disruptek";
  inputs.src-testes-1_1_4.repo  = "testes";
  inputs.src-testes-1_1_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-1_1_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-1_1_4";
