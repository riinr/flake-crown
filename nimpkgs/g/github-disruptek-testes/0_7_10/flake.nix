{
  ...
  inputs.src-testes-0_7_10.flake = false;
  inputs.src-testes-0_7_10.ref   = "refs/tags/0.7.10";
  inputs.src-testes-0_7_10.owner = "disruptek";
  inputs.src-testes-0_7_10.repo  = "testes";
  inputs.src-testes-0_7_10.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_7_10"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_7_10";
