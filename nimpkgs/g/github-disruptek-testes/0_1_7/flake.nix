{
  ...
  inputs.src-testes-0_1_7.flake = false;
  inputs.src-testes-0_1_7.ref   = "refs/tags/0.1.7";
  inputs.src-testes-0_1_7.owner = "disruptek";
  inputs.src-testes-0_1_7.repo  = "testes";
  inputs.src-testes-0_1_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_1_7"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_1_7";
