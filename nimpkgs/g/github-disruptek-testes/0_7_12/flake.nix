{
  ...
  inputs.src-testes-0_7_12.flake = false;
  inputs.src-testes-0_7_12.ref   = "refs/tags/0.7.12";
  inputs.src-testes-0_7_12.owner = "disruptek";
  inputs.src-testes-0_7_12.repo  = "testes";
  inputs.src-testes-0_7_12.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_7_12"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_7_12";
