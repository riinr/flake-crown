{
  ...
  inputs.src-testes-0_9_6.flake = false;
  inputs.src-testes-0_9_6.ref   = "refs/tags/0.9.6";
  inputs.src-testes-0_9_6.owner = "disruptek";
  inputs.src-testes-0_9_6.repo  = "testes";
  inputs.src-testes-0_9_6.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_9_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_9_6";
