{
  ...
  inputs.src-testes-1_0_0.flake = false;
  inputs.src-testes-1_0_0.ref   = "refs/tags/1.0.0";
  inputs.src-testes-1_0_0.owner = "disruptek";
  inputs.src-testes-1_0_0.repo  = "testes";
  inputs.src-testes-1_0_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-1_0_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-1_0_0";
