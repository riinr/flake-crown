{
  ...
  inputs.src-testes-0_7_3.flake = false;
  inputs.src-testes-0_7_3.ref   = "refs/tags/0.7.3";
  inputs.src-testes-0_7_3.owner = "disruptek";
  inputs.src-testes-0_7_3.repo  = "testes";
  inputs.src-testes-0_7_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_7_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_7_3";
