{
  ...
  inputs.src-testes-1_1_11.flake = false;
  inputs.src-testes-1_1_11.ref   = "refs/tags/1.1.11";
  inputs.src-testes-1_1_11.owner = "disruptek";
  inputs.src-testes-1_1_11.repo  = "testes";
  inputs.src-testes-1_1_11.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-1_1_11"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-1_1_11";
