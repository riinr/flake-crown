{
  ...
  inputs.src-testes-0_3_9.flake = false;
  inputs.src-testes-0_3_9.ref   = "refs/tags/0.3.9";
  inputs.src-testes-0_3_9.owner = "disruptek";
  inputs.src-testes-0_3_9.repo  = "testes";
  inputs.src-testes-0_3_9.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_3_9"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_3_9";
