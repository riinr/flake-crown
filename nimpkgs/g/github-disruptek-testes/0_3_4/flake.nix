{
  ...
  inputs.src-testes-0_3_4.flake = false;
  inputs.src-testes-0_3_4.ref   = "refs/tags/0.3.4";
  inputs.src-testes-0_3_4.owner = "disruptek";
  inputs.src-testes-0_3_4.repo  = "testes";
  inputs.src-testes-0_3_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_3_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_3_4";
