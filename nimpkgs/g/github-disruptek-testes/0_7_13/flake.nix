{
  ...
  inputs.src-testes-0_7_13.flake = false;
  inputs.src-testes-0_7_13.ref   = "refs/tags/0.7.13";
  inputs.src-testes-0_7_13.owner = "disruptek";
  inputs.src-testes-0_7_13.repo  = "testes";
  inputs.src-testes-0_7_13.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-testes-0_7_13"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-testes-0_7_13";
