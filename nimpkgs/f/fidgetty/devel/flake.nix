{
  ...
  inputs.src-fidgetty-devel.flake = false;
  inputs.src-fidgetty-devel.ref   = "refs/heads/devel";
  inputs.src-fidgetty-devel.owner = "elcritch";
  inputs.src-fidgetty-devel.repo  = "fidgets";
  inputs.src-fidgetty-devel.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-fidgetty-devel"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-fidgetty-devel";
