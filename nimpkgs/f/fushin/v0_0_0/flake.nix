{
  ...
  inputs.src-fushin-v0_0_0.flake = false;
  inputs.src-fushin-v0_0_0.ref   = "refs/tags/v0.0.0";
  inputs.src-fushin-v0_0_0.owner = "eggplants";
  inputs.src-fushin-v0_0_0.repo  = "fushin";
  inputs.src-fushin-v0_0_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-fushin-v0_0_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-fushin-v0_0_0";
