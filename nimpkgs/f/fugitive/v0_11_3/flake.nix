{
  ...
  inputs.src-fugitive-v0_11_3.flake = false;
  inputs.src-fugitive-v0_11_3.ref   = "refs/tags/v0.11.3";
  inputs.src-fugitive-v0_11_3.owner = "haltcase";
  inputs.src-fugitive-v0_11_3.repo  = "fugitive";
  inputs.src-fugitive-v0_11_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-fugitive-v0_11_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-fugitive-v0_11_3";
