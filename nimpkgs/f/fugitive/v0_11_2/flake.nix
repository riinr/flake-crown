{
  ...
  inputs.src-fugitive-v0_11_2.flake = false;
  inputs.src-fugitive-v0_11_2.ref   = "refs/tags/v0.11.2";
  inputs.src-fugitive-v0_11_2.owner = "haltcase";
  inputs.src-fugitive-v0_11_2.repo  = "fugitive";
  inputs.src-fugitive-v0_11_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-fugitive-v0_11_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-fugitive-v0_11_2";
