{
  ...
  inputs.src-dimscord-v1_4_0.flake = false;
  inputs.src-dimscord-v1_4_0.ref   = "refs/tags/v1.4.0";
  inputs.src-dimscord-v1_4_0.owner = "krisppurg";
  inputs.src-dimscord-v1_4_0.repo  = "dimscord";
  inputs.src-dimscord-v1_4_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dimscord-v1_4_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dimscord-v1_4_0";
