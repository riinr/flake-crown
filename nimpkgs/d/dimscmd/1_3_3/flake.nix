{
  ...
  inputs.src-dimscmd-1_3_3.flake = false;
  inputs.src-dimscmd-1_3_3.ref   = "refs/tags/1.3.3";
  inputs.src-dimscmd-1_3_3.owner = "ire4ever1190";
  inputs.src-dimscmd-1_3_3.repo  = "dimscordCommandHandler";
  inputs.src-dimscmd-1_3_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dimscmd-1_3_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dimscmd-1_3_3";
