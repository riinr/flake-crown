{
  ...
  inputs.src-datamancer-v0_2_9.flake = false;
  inputs.src-datamancer-v0_2_9.ref   = "refs/tags/v0.2.9";
  inputs.src-datamancer-v0_2_9.owner = "SciNim";
  inputs.src-datamancer-v0_2_9.repo  = "datamancer";
  inputs.src-datamancer-v0_2_9.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-datamancer-v0_2_9"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-datamancer-v0_2_9";
