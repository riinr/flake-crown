{
  ...
  inputs.src-datamancer-v0_3_5.flake = false;
  inputs.src-datamancer-v0_3_5.ref   = "refs/tags/v0.3.5";
  inputs.src-datamancer-v0_3_5.owner = "SciNim";
  inputs.src-datamancer-v0_3_5.repo  = "datamancer";
  inputs.src-datamancer-v0_3_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-datamancer-v0_3_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-datamancer-v0_3_5";
