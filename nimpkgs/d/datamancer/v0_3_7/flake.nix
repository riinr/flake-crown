{
  ...
  inputs.src-datamancer-v0_3_7.flake = false;
  inputs.src-datamancer-v0_3_7.ref   = "refs/tags/v0.3.7";
  inputs.src-datamancer-v0_3_7.owner = "SciNim";
  inputs.src-datamancer-v0_3_7.repo  = "datamancer";
  inputs.src-datamancer-v0_3_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-datamancer-v0_3_7"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-datamancer-v0_3_7";
