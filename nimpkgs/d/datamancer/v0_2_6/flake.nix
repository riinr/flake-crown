{
  ...
  inputs.src-datamancer-v0_2_6.flake = false;
  inputs.src-datamancer-v0_2_6.ref   = "refs/tags/v0.2.6";
  inputs.src-datamancer-v0_2_6.owner = "SciNim";
  inputs.src-datamancer-v0_2_6.repo  = "datamancer";
  inputs.src-datamancer-v0_2_6.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-datamancer-v0_2_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-datamancer-v0_2_6";
