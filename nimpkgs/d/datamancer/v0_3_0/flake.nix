{
  ...
  inputs.src-datamancer-v0_3_0.flake = false;
  inputs.src-datamancer-v0_3_0.ref   = "refs/tags/v0.3.0";
  inputs.src-datamancer-v0_3_0.owner = "SciNim";
  inputs.src-datamancer-v0_3_0.repo  = "datamancer";
  inputs.src-datamancer-v0_3_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-datamancer-v0_3_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-datamancer-v0_3_0";
