{
  ...
  inputs.src-deser_json-v0_1_0.flake = false;
  inputs.src-deser_json-v0_1_0.ref   = "refs/tags/v0.1.0";
  inputs.src-deser_json-v0_1_0.owner = "gabbhack";
  inputs.src-deser_json-v0_1_0.repo  = "deser_json";
  inputs.src-deser_json-v0_1_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-deser_json-v0_1_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-deser_json-v0_1_0";
