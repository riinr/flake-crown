{
  ...
  inputs.src-deser_json-v0_1_1-1.flake = false;
  inputs.src-deser_json-v0_1_1-1.ref   = "refs/tags/v0.1.1-1";
  inputs.src-deser_json-v0_1_1-1.owner = "gabbhack";
  inputs.src-deser_json-v0_1_1-1.repo  = "deser_json";
  inputs.src-deser_json-v0_1_1-1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-deser_json-v0_1_1-1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-deser_json-v0_1_1-1";
