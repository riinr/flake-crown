{
  ...
  inputs.src-dye-v1_1_4.flake = false;
  inputs.src-dye-v1_1_4.ref   = "refs/tags/v1.1.4";
  inputs.src-dye-v1_1_4.owner = "Infinitybeond1";
  inputs.src-dye-v1_1_4.repo  = "dye";
  inputs.src-dye-v1_1_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dye-v1_1_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dye-v1_1_4";
