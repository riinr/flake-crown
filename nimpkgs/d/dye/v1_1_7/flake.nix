{
  ...
  inputs.src-dye-v1_1_7.flake = false;
  inputs.src-dye-v1_1_7.ref   = "refs/tags/v1.1.7";
  inputs.src-dye-v1_1_7.owner = "Infinitybeond1";
  inputs.src-dye-v1_1_7.repo  = "dye";
  inputs.src-dye-v1_1_7.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dye-v1_1_7"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dye-v1_1_7";
