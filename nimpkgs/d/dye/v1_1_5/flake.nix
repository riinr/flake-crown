{
  ...
  inputs.src-dye-v1_1_5.flake = false;
  inputs.src-dye-v1_1_5.ref   = "refs/tags/v1.1.5";
  inputs.src-dye-v1_1_5.owner = "Infinitybeond1";
  inputs.src-dye-v1_1_5.repo  = "dye";
  inputs.src-dye-v1_1_5.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dye-v1_1_5"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dye-v1_1_5";
