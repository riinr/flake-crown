{
  ...
  inputs.src-dye-v1_1_2.flake = false;
  inputs.src-dye-v1_1_2.ref   = "refs/tags/v1.1.2";
  inputs.src-dye-v1_1_2.owner = "Infinitybeond1";
  inputs.src-dye-v1_1_2.repo  = "dye";
  inputs.src-dye-v1_1_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dye-v1_1_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dye-v1_1_2";
