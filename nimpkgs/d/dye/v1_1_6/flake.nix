{
  ...
  inputs.src-dye-v1_1_6.flake = false;
  inputs.src-dye-v1_1_6.ref   = "refs/tags/v1.1.6";
  inputs.src-dye-v1_1_6.owner = "Infinitybeond1";
  inputs.src-dye-v1_1_6.repo  = "dye";
  inputs.src-dye-v1_1_6.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dye-v1_1_6"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dye-v1_1_6";
