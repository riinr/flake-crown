{
  ...
  inputs.src-dye-master.flake = false;
  inputs.src-dye-master.ref   = "refs/heads/master";
  inputs.src-dye-master.owner = "Infinitybeond1";
  inputs.src-dye-master.repo  = "dye";
  inputs.src-dye-master.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dye-master"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dye-master";
