{
  ...
  inputs.src-dye-v1_1_0.flake = false;
  inputs.src-dye-v1_1_0.ref   = "refs/tags/v1.1.0";
  inputs.src-dye-v1_1_0.owner = "Infinitybeond1";
  inputs.src-dye-v1_1_0.repo  = "dye";
  inputs.src-dye-v1_1_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dye-v1_1_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dye-v1_1_0";
