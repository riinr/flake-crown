{
  ...
  inputs.src-dye-v1_1_1.flake = false;
  inputs.src-dye-v1_1_1.ref   = "refs/tags/v1.1.1";
  inputs.src-dye-v1_1_1.owner = "Infinitybeond1";
  inputs.src-dye-v1_1_1.repo  = "dye";
  inputs.src-dye-v1_1_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dye-v1_1_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dye-v1_1_1";
