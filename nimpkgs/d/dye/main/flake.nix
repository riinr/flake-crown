{
  ...
  inputs.src-dye-main.flake = false;
  inputs.src-dye-main.ref   = "refs/heads/main";
  inputs.src-dye-main.owner = "Infinitybeond1";
  inputs.src-dye-main.repo  = "dye";
  inputs.src-dye-main.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-dye-main"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-dye-main";
