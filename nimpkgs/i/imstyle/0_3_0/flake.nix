{
  ...
  inputs.src-imstyle-0_3_0.flake = false;
  inputs.src-imstyle-0_3_0.ref   = "refs/tags/0.3.0";
  inputs.src-imstyle-0_3_0.owner = "Patitotective";
  inputs.src-imstyle-0_3_0.repo  = "ImStyle";
  inputs.src-imstyle-0_3_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-imstyle-0_3_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-imstyle-0_3_0";
