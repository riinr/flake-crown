{
  ...
  inputs.src-imstyle-0_3_2.flake = false;
  inputs.src-imstyle-0_3_2.ref   = "refs/tags/0.3.2";
  inputs.src-imstyle-0_3_2.owner = "Patitotective";
  inputs.src-imstyle-0_3_2.repo  = "ImStyle";
  inputs.src-imstyle-0_3_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-imstyle-0_3_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-imstyle-0_3_2";
