{
  ...
  inputs.src-iterrr-v1_0_4.flake = false;
  inputs.src-iterrr-v1_0_4.ref   = "refs/tags/v1.0.4";
  inputs.src-iterrr-v1_0_4.owner = "hamidb80";
  inputs.src-iterrr-v1_0_4.repo  = "iterrr";
  inputs.src-iterrr-v1_0_4.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-iterrr-v1_0_4"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-iterrr-v1_0_4";
