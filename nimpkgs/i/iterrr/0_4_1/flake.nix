{
  ...
  inputs.src-iterrr-0_4_1.flake = false;
  inputs.src-iterrr-0_4_1.ref   = "refs/tags/0.4.1";
  inputs.src-iterrr-0_4_1.owner = "hamidb80";
  inputs.src-iterrr-0_4_1.repo  = "iterrr";
  inputs.src-iterrr-0_4_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-iterrr-0_4_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-iterrr-0_4_1";
