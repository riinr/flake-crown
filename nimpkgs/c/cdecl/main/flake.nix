{
  ...
  inputs.src-cdecl-main.flake = false;
  inputs.src-cdecl-main.ref   = "refs/heads/main";
  inputs.src-cdecl-main.owner = "elcritch";
  inputs.src-cdecl-main.repo  = "cdecl";
  inputs.src-cdecl-main.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cdecl-main"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cdecl-main";
