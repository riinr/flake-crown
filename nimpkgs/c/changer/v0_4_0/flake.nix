{
  ...
  inputs.src-changer-v0_4_0.flake = false;
  inputs.src-changer-v0_4_0.ref   = "refs/tags/v0.4.0";
  inputs.src-changer-v0_4_0.owner = "iffy";
  inputs.src-changer-v0_4_0.repo  = "changer";
  inputs.src-changer-v0_4_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-changer-v0_4_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-changer-v0_4_0";
