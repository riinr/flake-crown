{
  ...
  inputs.src-chronicles-v0_10_3.flake = false;
  inputs.src-chronicles-v0_10_3.ref   = "refs/tags/v0.10.3";
  inputs.src-chronicles-v0_10_3.owner = "status-im";
  inputs.src-chronicles-v0_10_3.repo  = "nim-chronicles";
  inputs.src-chronicles-v0_10_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-chronicles-v0_10_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-chronicles-v0_10_3";
