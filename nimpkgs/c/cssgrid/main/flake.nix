{
  ...
  inputs.src-cssgrid-main.flake = false;
  inputs.src-cssgrid-main.ref   = "refs/heads/main";
  inputs.src-cssgrid-main.owner = "elcritch";
  inputs.src-cssgrid-main.repo  = "cssgrid";
  inputs.src-cssgrid-main.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-cssgrid-main"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-cssgrid-main";
