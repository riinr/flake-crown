{
  ...
  inputs.src-crowngui-devel.flake = false;
  inputs.src-crowngui-devel.ref   = "refs/heads/devel";
  inputs.src-crowngui-devel.owner = "bung87";
  inputs.src-crowngui-devel.repo  = "crowngui";
  inputs.src-crowngui-devel.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-crowngui-devel"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-crowngui-devel";
