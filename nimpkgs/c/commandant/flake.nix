{
  ...
  inputs."commandeer-0_13_0".dir   = "0_13_0";
  inputs."commandeer-0_13_0".owner = "nim-nix-pkgs";
  inputs."commandeer-0_13_0".ref   = "master";
  inputs."commandeer-0_13_0".repo  = "commandeer";
  inputs."commandeer-0_13_0".type  = "github";
  inputs."commandeer-0_13_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."commandeer-0_13_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."commandeer-0_14_0".dir   = "0_14_0";
  inputs."commandeer-0_14_0".owner = "nim-nix-pkgs";
  inputs."commandeer-0_14_0".ref   = "master";
  inputs."commandeer-0_14_0".repo  = "commandeer";
  inputs."commandeer-0_14_0".type  = "github";
  inputs."commandeer-0_14_0".inputs.nixpkgs.follows = "nixpkgs";
  inputs."commandeer-0_14_0".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
