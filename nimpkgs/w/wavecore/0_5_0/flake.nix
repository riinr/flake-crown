{
  ...
  inputs.src-wavecore-0_5_0.flake = false;
  inputs.src-wavecore-0_5_0.owner = "ansiwave";
  inputs.src-wavecore-0_5_0.ref   = "refs/tags/0.5.0";
  inputs.src-wavecore-0_5_0.repo  = "wavecore";
  inputs.src-wavecore-0_5_0.type  = "github";
  ...
  inputs."threading".dir   = "nimpkgs/t/threading";
  inputs."threading".owner = "riinr";
  inputs."threading".ref   = "flake-pinning";
  inputs."threading".repo  = "flake-nimble";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-wavecore-0_5_0"];
  in lib.mkRefOutput {
    inherit self nixpkgs ;
    src  = deps."src-wavecore-0_5_0";
