{
  ...
  inputs.src-wavecore-0_6_0.flake = false;
  inputs.src-wavecore-0_6_0.ref   = "refs/tags/0.6.0";
  inputs.src-wavecore-0_6_0.owner = "ansiwave";
  inputs.src-wavecore-0_6_0.repo  = "wavecore";
  inputs.src-wavecore-0_6_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-wavecore-0_6_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-wavecore-0_6_0";
