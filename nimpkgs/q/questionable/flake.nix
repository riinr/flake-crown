{
  ...
  inputs."questionable-0_10_3".dir   = "0_10_3";
  inputs."questionable-0_10_3".owner = "nim-nix-pkgs";
  inputs."questionable-0_10_3".ref   = "master";
  inputs."questionable-0_10_3".repo  = "questionable";
  inputs."questionable-0_10_3".type  = "github";
  ...
  inputs."questionable-0_10_5".dir   = "0_10_5";
  inputs."questionable-0_10_5".owner = "nim-nix-pkgs";
  inputs."questionable-0_10_5".ref   = "master";
  inputs."questionable-0_10_5".repo  = "questionable";
  inputs."questionable-0_10_5".type  = "github";
  inputs."questionable-0_10_5".inputs.nixpkgs.follows = "nixpkgs";
  inputs."questionable-0_10_5".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."questionable-0_10_6".dir   = "0_10_6";
  inputs."questionable-0_10_6".owner = "nim-nix-pkgs";
  inputs."questionable-0_10_6".ref   = "master";
  inputs."questionable-0_10_6".repo  = "questionable";
  inputs."questionable-0_10_6".type  = "github";
  inputs."questionable-0_10_6".inputs.nixpkgs.follows = "nixpkgs";
  inputs."questionable-0_10_6".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
  
  inputs."questionable-0_10_7".dir   = "0_10_7";
  inputs."questionable-0_10_7".owner = "nim-nix-pkgs";
  inputs."questionable-0_10_7".ref   = "master";
  inputs."questionable-0_10_7".repo  = "questionable";
  inputs."questionable-0_10_7".type  = "github";
  inputs."questionable-0_10_7".inputs.nixpkgs.follows = "nixpkgs";
  inputs."questionable-0_10_7".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
