{
  ...
  inputs.src-libpe-v0_3_0.flake = false;
  inputs.src-libpe-v0_3_0.ref   = "refs/tags/v0.3.0";
  inputs.src-libpe-v0_3_0.owner = "srozb";
  inputs.src-libpe-v0_3_0.repo  = "nim-libpe";
  inputs.src-libpe-v0_3_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-libpe-v0_3_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-libpe-v0_3_0";
