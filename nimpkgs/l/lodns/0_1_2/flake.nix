{
  ...
  inputs.src-lodns-0_1_2.flake = false;
  inputs.src-lodns-0_1_2.ref   = "refs/tags/0.1.2";
  inputs.src-lodns-0_1_2.owner = "vandot";
  inputs.src-lodns-0_1_2.repo  = "lodns";
  inputs.src-lodns-0_1_2.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-lodns-0_1_2"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-lodns-0_1_2";
