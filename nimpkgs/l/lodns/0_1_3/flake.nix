{
  ...
  inputs.src-lodns-0_1_3.flake = false;
  inputs.src-lodns-0_1_3.ref   = "refs/tags/0.1.3";
  inputs.src-lodns-0_1_3.owner = "vandot";
  inputs.src-lodns-0_1_3.repo  = "lodns";
  inputs.src-lodns-0_1_3.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-lodns-0_1_3"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-lodns-0_1_3";
