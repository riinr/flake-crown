{
  ...
  inputs.src-lodns-0_1_0.flake = false;
  inputs.src-lodns-0_1_0.ref   = "refs/tags/0.1.0";
  inputs.src-lodns-0_1_0.owner = "vandot";
  inputs.src-lodns-0_1_0.repo  = "lodns";
  inputs.src-lodns-0_1_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-lodns-0_1_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-lodns-0_1_0";
