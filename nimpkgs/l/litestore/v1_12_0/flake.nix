{
  ...
  inputs.src-litestore-v1_12_0.flake = false;
  inputs.src-litestore-v1_12_0.ref   = "refs/tags/v1.12.0";
  inputs.src-litestore-v1_12_0.owner = "h3rald";
  inputs.src-litestore-v1_12_0.repo  = "litestore";
  inputs.src-litestore-v1_12_0.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-litestore-v1_12_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-litestore-v1_12_0";
