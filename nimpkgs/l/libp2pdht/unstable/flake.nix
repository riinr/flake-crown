{
  ...
  inputs.src-libp2pdht-unstable.flake = false;
  inputs.src-libp2pdht-unstable.ref   = "refs/heads/unstable";
  inputs.src-libp2pdht-unstable.owner = "status-im";
  inputs.src-libp2pdht-unstable.repo  = "nim-libp2p-dht";
  inputs.src-libp2pdht-unstable.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-libp2pdht-unstable"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-libp2pdht-unstable";
