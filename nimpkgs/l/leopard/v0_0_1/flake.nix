{
  ...
  inputs.src-leopard-v0_0_1.flake = false;
  inputs.src-leopard-v0_0_1.ref   = "refs/tags/v0.0.1";
  inputs.src-leopard-v0_0_1.owner = "status-im";
  inputs.src-leopard-v0_0_1.repo  = "nim-leopard";
  inputs.src-leopard-v0_0_1.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-leopard-v0_0_1"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-leopard-v0_0_1";
